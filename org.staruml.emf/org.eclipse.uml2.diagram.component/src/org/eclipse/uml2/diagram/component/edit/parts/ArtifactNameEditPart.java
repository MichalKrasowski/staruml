...
public class ArtifactNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			ArtifactEditPart parent = (ArtifactEditPart) getParent();
			ArtifactStereo2EditPart stereoLabel = (ArtifactStereo2EditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(ArtifactStereo2EditPart.VISUAL_ID));
			if (stereoLabel != null) {
