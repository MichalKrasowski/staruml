 ...
 * @generated
 */
public class AssemblyConnectorCircleCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public AssemblyConnectorCircleCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		owner.getOwnedConnectors().add(newElement);
