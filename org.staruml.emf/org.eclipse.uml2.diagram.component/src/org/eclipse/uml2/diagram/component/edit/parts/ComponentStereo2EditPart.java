...
public class ComponentStereo2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ComponentStereo2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Component_3001, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.component.edit.parts.ComponentStereo2EditPart.VISUAL_ID));
		}
		return parser;
	}
