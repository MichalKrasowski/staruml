...
public class ClassDiagramNotationClassContributionItemProvider extends AbstractContributionItemProvider implements IProvider {
	...
	protected IAction createAction(String actionId, IWorkbenchPartDescriptor partDescriptor) {
		...
		if (TurnIntoClass2Action.ACTION_ID.equals(actionId)) {
			return new TurnIntoClass2Action(workbenchPage, actionId);
		}
	 ...
	 * @generated
	 */
	public static final String MENU_LABEL = Messages.ClassDiagramNotationClassContributionItemProvider_menu;
	 ...
	 * @generated
	 */
	public static final String GROUP_LABEL = Messages.ClassDiagramNotationClassContributionItemProvider_group;
}
