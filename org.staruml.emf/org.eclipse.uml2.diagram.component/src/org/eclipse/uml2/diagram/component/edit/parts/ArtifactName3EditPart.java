...
public class ArtifactName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ArtifactName3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Artifact_3016, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.component.edit.parts.ArtifactName3EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			Artifact3EditPart parent = (Artifact3EditPart) getParent();
			ArtifactStereo3EditPart stereoLabel = (ArtifactStereo3EditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(ArtifactStereo3EditPart.VISUAL_ID));
			if (stereoLabel != null) {
