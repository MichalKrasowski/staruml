...
public class ComponentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Component_3001, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.component.edit.parts.ComponentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			Component2EditPart parent = (Component2EditPart) getParent();
			ComponentStereo2EditPart stereoLabel = (ComponentStereo2EditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(ComponentStereo2EditPart.VISUAL_ID));
			if (stereoLabel != null) {
