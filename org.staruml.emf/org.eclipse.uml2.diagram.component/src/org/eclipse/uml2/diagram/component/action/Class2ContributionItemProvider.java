...
public class Class2ContributionItemProvider extends AbstractContributionItemProvider implements IProvider {
	...
	protected IAction createAction(String actionId, IWorkbenchPartDescriptor partDescriptor) {
		...
		if (TurnIntoClassDiagramNotationClassAction.ACTION_ID.equals(actionId)) {
			return new TurnIntoClassDiagramNotationClassAction(workbenchPage, actionId);
		}
	 ...
	 * @generated
	 */
	public static final String MENU_LABEL = Messages.Class2ContributionItemProvider_menu;
	 ...
	 * @generated
	 */
	public static final String GROUP_LABEL = Messages.Class2ContributionItemProvider_group;
}
