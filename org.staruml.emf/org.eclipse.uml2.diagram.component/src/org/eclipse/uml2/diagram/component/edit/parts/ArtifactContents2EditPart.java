...
import org.eclipse.uml2.diagram.component.edit.policies.ArtifactContents2CanonicalEditPolicy;
import org.eclipse.uml2.diagram.component.edit.policies.ArtifactContents2ItemSemanticEditPolicy;
...
public class ArtifactContents2EditPart extends ShapeCompartmentEditPart {
	 ...
	 * @generated
	 */
	public ArtifactContents2EditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.ArtifactContents2EditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ArtifactContents2ItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ArtifactContents2CanonicalEditPolicy());
