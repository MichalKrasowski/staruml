 ...
 * @generated
 */
public class ClassDiagramNotationClassNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ClassDiagramNotationClassNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Class_2007, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.component.edit.parts.ClassDiagramNotationClassNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			ClassDiagramNotationClassEditPart parent = (ClassDiagramNotationClassEditPart) getParent();
			ClassDiagramNotationClassStereotypeEditPart stereoLabel = (ClassDiagramNotationClassStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(ClassDiagramNotationClassStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
