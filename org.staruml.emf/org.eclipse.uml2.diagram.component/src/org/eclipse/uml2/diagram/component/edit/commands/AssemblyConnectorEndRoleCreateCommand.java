 ...
 * @generated
 */
public class AssemblyConnectorEndRoleCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AssemblyConnectorEndRoleCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	public boolean canExecute() {
		...
		return UMLBaseItemSemanticEditPolicy.LinkConstraints.canCreateConnectorEndRole_4010(getSource(), getTarget());
	}
