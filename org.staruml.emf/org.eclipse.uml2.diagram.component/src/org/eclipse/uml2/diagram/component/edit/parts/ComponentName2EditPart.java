...
public class ComponentName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Component_2001, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.component.edit.parts.ComponentName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			...
			ComponentStereoEditPart stereoLabel = (ComponentStereoEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(ComponentStereoEditPart.VISUAL_ID));
			if (stereoLabel != null) {
