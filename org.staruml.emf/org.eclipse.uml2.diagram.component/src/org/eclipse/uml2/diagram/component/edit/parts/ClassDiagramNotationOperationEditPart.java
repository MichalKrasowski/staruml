...
import org.eclipse.uml2.diagram.component.edit.policies.ClassDiagramNotationOperationItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ClassDiagramNotationOperationEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ClassDiagramNotationOperationEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ClassDiagramNotationOperationItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Operation_3012, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.component.edit.parts.ClassDiagramNotationOperationEditPart.VISUAL_ID));
		}
		return parser;
	}
