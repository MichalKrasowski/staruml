...
public class ArtifactName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Artifact_2002, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.component.edit.parts.ArtifactName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			Artifact2EditPart parent = (Artifact2EditPart) getParent();
			ArtifactStereoEditPart stereoLabel = (ArtifactStereoEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(ArtifactStereoEditPart.VISUAL_ID));
			if (stereoLabel != null) {
