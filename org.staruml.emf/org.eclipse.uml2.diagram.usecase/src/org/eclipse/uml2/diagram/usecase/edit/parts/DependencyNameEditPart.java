...
public class DependencyNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.usecase.edit.parts.DependencyNameEditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Dependency_4006, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.usecase.edit.parts.DependencyNameEditPart.VISUAL_ID));
		}
		return parser;
	}
