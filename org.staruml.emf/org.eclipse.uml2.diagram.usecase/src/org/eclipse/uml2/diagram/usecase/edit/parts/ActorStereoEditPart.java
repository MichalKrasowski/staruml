...
public class ActorStereoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActorStereoEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(UMLElementTypes.Actor_2005, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.usecase.edit.parts.ActorStereoEditPart.VISUAL_ID));
		}
		return parser;
	}
