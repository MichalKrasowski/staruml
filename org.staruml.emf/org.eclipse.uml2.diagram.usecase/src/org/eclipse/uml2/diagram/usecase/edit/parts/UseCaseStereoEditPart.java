...
public class UseCaseStereoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public UseCaseStereoEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.UseCase_2004, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.usecase.edit.parts.UseCaseStereoEditPart.VISUAL_ID));
		}
		return parser;
	}
