 ...
 * @generated
 */
public class IncludeLink_fixedEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.usecase.edit.parts.IncludeLink_fixedEditPart.VISUAL_ID), new Point(0, 20));
	}

	/**
	 * @generated
	 */
	public IncludeLink_fixedEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Include_4001, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.usecase.edit.parts.IncludeLink_fixedEditPart.VISUAL_ID));
		}
		return parser;
	}
	 ...
	 * @generated
	 */
	public class IncludeLink_fixed extends Label {
	...
	private boolean isVisibleByPreferences() {
		return DiagramIconStylePreferenceHelper.shouldShowLabel(IncludeLink_fixedEditPart.VISUAL_ID, getDiagramPreferencesHint());
	}
