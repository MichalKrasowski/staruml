 ...
 * @generated
 */
public class AssociationTargetMultiplicityEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.usecase.edit.parts.AssociationTargetMultiplicityEditPart.VISUAL_ID), new Point(0, 15));
	}

	/**
	 * @generated
	 */
	public AssociationTargetMultiplicityEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Association_4004, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.usecase.edit.parts.AssociationTargetMultiplicityEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	private boolean isVisibleByPreferences() {
		return DiagramIconStylePreferenceHelper.shouldShowLabel(AssociationTargetMultiplicityEditPart.VISUAL_ID, getDiagramPreferencesHint());
	}
