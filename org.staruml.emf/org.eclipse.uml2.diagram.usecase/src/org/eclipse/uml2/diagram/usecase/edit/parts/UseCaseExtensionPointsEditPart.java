...
import org.eclipse.uml2.diagram.usecase.edit.policies.UseCaseExtensionPointsCanonicalEditPolicy;
import org.eclipse.uml2.diagram.usecase.edit.policies.UseCaseExtensionPointsItemSemanticEditPolicy;
 ...
 * @generated
 */
public class UseCaseExtensionPointsEditPart extends ListCompartmentEditPart implements IInsertableEditPart {
	 ...
	 * @generated
	 */
	public UseCaseExtensionPointsEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.UseCaseExtensionPointsEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new UseCaseExtensionPointsItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(UMLVisualIDRegistry.TYPED_ADAPTER));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new UseCaseExtensionPointsCanonicalEditPolicy());
