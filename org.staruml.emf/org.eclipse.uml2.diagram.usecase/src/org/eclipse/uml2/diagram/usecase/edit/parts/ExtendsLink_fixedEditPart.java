 ...
 * @generated
 */
public class ExtendsLink_fixedEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.usecase.edit.parts.ExtendsLink_fixedEditPart.VISUAL_ID), new Point(0, 20));
	}

	/**
	 * @generated
	 */
	public ExtendsLink_fixedEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Extend_4002, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.usecase.edit.parts.ExtendsLink_fixedEditPart.VISUAL_ID));
		}
		return parser;
	}
	 ...
	 * @generated
	 */
	public class ExtendsLink_fixed extends Label {
	...
	private boolean isVisibleByPreferences() {
		return DiagramIconStylePreferenceHelper.shouldShowLabel(ExtendsLink_fixedEditPart.VISUAL_ID, getDiagramPreferencesHint());
	}
