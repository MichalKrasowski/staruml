...
public class StructuredActivityNode_CentralBufferNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StructuredActivityNode_CentralBufferNodeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CentralBufferNode_3025, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.StructuredActivityNode_CentralBufferNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			StructuredActivityNode_CentralBufferNodeEditPart parent = (StructuredActivityNode_CentralBufferNodeEditPart) getParent();
			StructuredActivityNode_CentralBufferNodeStereotypeEditPart stereoLabel = (StructuredActivityNode_CentralBufferNodeStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(StructuredActivityNode_CentralBufferNodeStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
