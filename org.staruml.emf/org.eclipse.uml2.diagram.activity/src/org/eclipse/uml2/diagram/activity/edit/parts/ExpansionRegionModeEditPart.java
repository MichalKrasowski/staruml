...
public class ExpansionRegionModeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ExpansionRegion_3084, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.ExpansionRegionModeEditPart.VISUAL_ID));
		}
		return parser;
	}
