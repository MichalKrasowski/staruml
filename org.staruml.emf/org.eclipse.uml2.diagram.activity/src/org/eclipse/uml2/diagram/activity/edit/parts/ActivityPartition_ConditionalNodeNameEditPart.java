...
public class ActivityPartition_ConditionalNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActivityPartition_ConditionalNodeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ConditionalNode_3083, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.ActivityPartition_ConditionalNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			ActivityPartition_ConditionalNodeEditPart parent = (ActivityPartition_ConditionalNodeEditPart) getParent();
			ActivityPartition_ConditionalNodeStereotypeEditPart stereoLabel = (ActivityPartition_ConditionalNodeStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
