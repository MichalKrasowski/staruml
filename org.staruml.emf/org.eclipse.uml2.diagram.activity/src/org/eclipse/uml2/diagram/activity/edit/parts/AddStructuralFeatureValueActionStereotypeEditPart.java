...
public class AddStructuralFeatureValueActionStereotypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AddStructuralFeatureValueActionStereotypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.AddStructuralFeatureValueAction_3043, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.AddStructuralFeatureValueActionStereotypeEditPart.VISUAL_ID));
		}
		return parser;
	}
