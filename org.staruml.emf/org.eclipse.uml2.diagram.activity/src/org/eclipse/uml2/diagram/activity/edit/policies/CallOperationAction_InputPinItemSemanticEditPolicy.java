...
public class CallOperationAction_InputPinItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public CallOperationAction_InputPinItemSemanticEditPolicy() {
		super(UMLElementTypes.InputPin_3008);
	}
