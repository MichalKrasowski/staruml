...
public class ActivityParameterNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ActivityParameterNode_3052, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.ActivityParameterNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			ActivityParameterNodeEditPart parent = (ActivityParameterNodeEditPart) getParent();
			ActivityParameterNodeStereotypeEditPart stereoLabel = (ActivityParameterNodeStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(ActivityParameterNodeStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
