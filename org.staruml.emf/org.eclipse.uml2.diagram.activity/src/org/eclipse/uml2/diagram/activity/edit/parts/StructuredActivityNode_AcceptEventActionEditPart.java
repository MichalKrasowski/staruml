...
import org.eclipse.uml2.diagram.activity.edit.policies.StructuredActivityNode_AcceptEventActionCanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.StructuredActivityNode_AcceptEventActionItemSemanticEditPolicy;
...
public class StructuredActivityNode_AcceptEventActionEditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public StructuredActivityNode_AcceptEventActionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StructuredActivityNode_AcceptEventActionItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new StructuredActivityNode_AcceptEventActionCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof StructuredActivityNode_AcceptEventActionNameEditPart) {
			((StructuredActivityNode_AcceptEventActionNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAcceptEventActionFigure_name());
			return true;
		}
		if (childEditPart instanceof StructuredActivityNode_AcceptEventActionStereotypeEditPart) {
			((StructuredActivityNode_AcceptEventActionStereotypeEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAcceptEventActionFigure_stereo());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(StructuredActivityNode_AcceptEventActionNameEditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.StructuredActivityNode_AcceptEventActionEditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
	...
	public class AcceptEventActionFigure extends Shape {
		 ...
		 * @generated
		 */
		public StereotypeLabel2 getFigureAcceptEventActionFigure_stereo() {
	...
	protected void addSemanticListeners() {
		...
		for (IUpdaterNodeDescriptor next : getAcceptEventAction_3012ContainedLinks()) {
	...
	private List<IUpdaterLinkDescriptor> getAcceptEventAction_3012ContainedLinks() {
		return UMLDiagramUpdater.getAcceptEventAction_3012ContainedLinks(getNotationView());
	}
	...
	protected EditPart chooseLabelEditPartForDirectEditRequest(Request request) {
		if (request.getExtendedData().containsKey(RequestConstants.REQ_DIRECTEDIT_EXTENDEDDATA_INITIAL_CHAR)) {
			...
			if (initialChar.charValue() == '<') {
				EditPart result = getChildBySemanticHint(UMLVisualIDRegistry.getType(StructuredActivityNode_AcceptEventActionStereotypeEditPart.VISUAL_ID));
				if (result != null) {
					return result;
				}
			}
