...
public class SendSignalActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.SendSignalAction_3053, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.SendSignalActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			SendSignalActionEditPart parent = (SendSignalActionEditPart) getParent();
			SendSignalActionStereotypeEditPart stereoLabel = (SendSignalActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(SendSignalActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
