...
public class ActivityPartition_ValueSpecificationActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActivityPartition_ValueSpecificationActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ValueSpecificationAction_3088, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.ActivityPartition_ValueSpecificationActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			ActivityPartition_ValueSpecificationActionEditPart parent = (ActivityPartition_ValueSpecificationActionEditPart) getParent();
			ActivityPartition_ValueSpecificationActionStereotypeEditPart stereoLabel = (ActivityPartition_ValueSpecificationActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(ActivityPartition_ValueSpecificationActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
