...
public class ValueSpecificationActionStereotypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ValueSpecificationActionStereotypeEditPart(View view) {
		super(view);
	}
