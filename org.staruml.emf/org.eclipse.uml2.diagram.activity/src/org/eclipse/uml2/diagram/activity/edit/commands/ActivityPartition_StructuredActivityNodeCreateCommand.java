...
public class ActivityPartition_StructuredActivityNodeCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public ActivityPartition_StructuredActivityNodeCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResultGen(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		UMLElementTypes.init_StructuredActivityNode_3076(newElement);
