...
public class ActivityPartition_AddStructuralFeatureValueActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			ActivityPartition_AddStructuralFeatureValueActionEditPart parent = (ActivityPartition_AddStructuralFeatureValueActionEditPart) getParent();
			ActivityPartition_AddStructuralFeatureValueActionStereotypeEditPart stereoLabel = (ActivityPartition_AddStructuralFeatureValueActionStereotypeEditPart) parent
					.getChildBySemanticHint(UMLVisualIDRegistry.getType(ActivityPartition_AddStructuralFeatureValueActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
