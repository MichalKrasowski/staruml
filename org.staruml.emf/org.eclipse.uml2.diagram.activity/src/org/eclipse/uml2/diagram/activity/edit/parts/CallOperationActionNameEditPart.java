...
public class CallOperationActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CallOperationAction_3045, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.CallOperationActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			CallOperationActionEditPart parent = (CallOperationActionEditPart) getParent();
			CallOperationActionStereotypeEditPart stereoLabel = (CallOperationActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(CallOperationActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
