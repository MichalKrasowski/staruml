...
public class StructuredActivityNode_CallOperationActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StructuredActivityNode_CallOperationActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CallOperationAction_3020, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.StructuredActivityNode_CallOperationActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			StructuredActivityNode_CallOperationActionEditPart parent = (StructuredActivityNode_CallOperationActionEditPart) getParent();
			StructuredActivityNode_CallOperationActionStereotypeEditPart stereoLabel = (StructuredActivityNode_CallOperationActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(StructuredActivityNode_CallOperationActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
