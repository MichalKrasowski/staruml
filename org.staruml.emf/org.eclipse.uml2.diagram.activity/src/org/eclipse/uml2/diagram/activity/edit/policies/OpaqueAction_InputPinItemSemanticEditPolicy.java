...
public class OpaqueAction_InputPinItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public OpaqueAction_InputPinItemSemanticEditPolicy() {
		super(UMLElementTypes.InputPin_3094);
	}
