...
public class StructuredActivityNode_DataStoreNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StructuredActivityNode_DataStoreNodeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.DataStoreNode_3024, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.StructuredActivityNode_DataStoreNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			StructuredActivityNode_DataStoreNodeEditPart parent = (StructuredActivityNode_DataStoreNodeEditPart) getParent();
			StructuredActivityNode_DataStoreNodeStereotypeEditPart stereoLabel = (StructuredActivityNode_DataStoreNodeStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(StructuredActivityNode_DataStoreNodeStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
