...
public class ExpansionNodeItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ExpansionNodeItemSemanticEditPolicy() {
		super(UMLElementTypes.ExpansionNode_3091);
	}
