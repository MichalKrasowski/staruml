...
import org.eclipse.uml2.diagram.activity.edit.policies.LocalPrecondition_LiteralStringItemSemanticEditPolicy;
...
public class LocalPrecondition_LiteralStringEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LocalPrecondition_LiteralStringEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new LocalPrecondition_LiteralStringItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.LiteralString_3049, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.LocalPrecondition_LiteralStringEditPart.VISUAL_ID));
		}
		return parser;
	}
