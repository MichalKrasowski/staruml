...
public class ActivityPartition_ActivityPartitionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActivityPartition_ActivityPartitionNameEditPart(View view) {
		super(view);
	}
