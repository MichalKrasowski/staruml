...
public class StructuredActivityNodeStereotypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StructuredActivityNodeStereotypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.StructuredActivityNode_3046, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.StructuredActivityNodeStereotypeEditPart.VISUAL_ID));
		}
		return parser;
	}
