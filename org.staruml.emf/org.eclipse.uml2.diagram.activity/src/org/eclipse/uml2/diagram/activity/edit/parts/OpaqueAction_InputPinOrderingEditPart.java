...
public class OpaqueAction_InputPinOrderingEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.OpaqueAction_InputPinOrderingEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public OpaqueAction_InputPinOrderingEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InputPin_3094, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.OpaqueAction_InputPinOrderingEditPart.VISUAL_ID));
		}
		return parser;
	}
