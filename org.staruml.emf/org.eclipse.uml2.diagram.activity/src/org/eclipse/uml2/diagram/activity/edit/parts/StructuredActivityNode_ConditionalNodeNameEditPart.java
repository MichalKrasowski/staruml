...
public class StructuredActivityNode_ConditionalNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StructuredActivityNode_ConditionalNodeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ConditionalNode_3092, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.StructuredActivityNode_ConditionalNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			StructuredActivityNode_ConditionalNodeEditPart parent = (StructuredActivityNode_ConditionalNodeEditPart) getParent();
			StructuredActivityNode_ConditionalNodeStereotypeEditPart stereoLabel = (StructuredActivityNode_ConditionalNodeStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(StructuredActivityNode_ConditionalNodeStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
