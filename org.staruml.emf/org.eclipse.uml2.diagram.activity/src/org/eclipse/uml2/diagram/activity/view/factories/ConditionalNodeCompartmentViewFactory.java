...
public class ConditionalNodeCompartmentViewFactory extends BasicNodeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = UMLVisualIDRegistry.getType(ConditionalNodeCompartmentEditPart.VISUAL_ID);
