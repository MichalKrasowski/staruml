...
import org.eclipse.uml2.diagram.activity.edit.policies.CallAction_OutputPinCanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.CallAction_OutputPinItemSemanticEditPolicy;
...
public class CallAction_OutputPinEditPart extends BorderedBorderItemEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public CallAction_OutputPinEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CallAction_OutputPinItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CallAction_OutputPinCanonicalEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof CallAction_OutputPinNameEditPart || borderItemEditPart instanceof CallAction_OutputPinOrderingEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(CallAction_OutputPinNameEditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.CallAction_OutputPinEditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
