...
import org.eclipse.uml2.diagram.activity.edit.policies.AcceptEventAction5CanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.ActivityPartition_AcceptEventActionItemSemanticEditPolicy;
...
public class ActivityPartition_AcceptEventActionEditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public ActivityPartition_AcceptEventActionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ActivityPartition_AcceptEventActionItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new AcceptEventAction5CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ActivityPartition_AcceptEventActionNameEditPart) {
			((ActivityPartition_AcceptEventActionNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAcceptEventActionFigure_name());
			return true;
		}
		if (childEditPart instanceof ActivityPartition_AcceptEventActionStereotypeEditPart) {
			((ActivityPartition_AcceptEventActionStereotypeEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAcceptEventActionFigure_stereo());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ActivityPartition_AcceptEventActionNameEditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.ActivityPartition_AcceptEventActionEditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
	...
	protected void addSemanticListeners() {
		...
		for (IUpdaterNodeDescriptor next : getAcceptEventAction_3059ContainedLinks()) {
	...
	private List<IUpdaterLinkDescriptor> getAcceptEventAction_3059ContainedLinks() {
		return UMLDiagramUpdater.getAcceptEventAction_3059ContainedLinks(getNotationView());
	}
	...
	protected EditPart chooseLabelEditPartForDirectEditRequest(Request request) {
		if (request.getExtendedData().containsKey(RequestConstants.REQ_DIRECTEDIT_EXTENDEDDATA_INITIAL_CHAR)) {
			...
			if (initialChar.charValue() == '<') {
				EditPart result = getChildBySemanticHint(UMLVisualIDRegistry.getType(ActivityPartition_AcceptEventActionStereotypeEditPart.VISUAL_ID));
				if (result != null) {
					return result;
				}
			}
