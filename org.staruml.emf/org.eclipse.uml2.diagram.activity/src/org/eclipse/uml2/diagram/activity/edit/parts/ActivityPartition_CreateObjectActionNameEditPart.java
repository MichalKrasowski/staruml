...
public class ActivityPartition_CreateObjectActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActivityPartition_CreateObjectActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CreateObjectAction_3072, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.ActivityPartition_CreateObjectActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			ActivityPartition_CreateObjectActionEditPart parent = (ActivityPartition_CreateObjectActionEditPart) getParent();
			ActivityPartition_CreateObjectActionStereotypeEditPart stereoLabel = (ActivityPartition_CreateObjectActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(ActivityPartition_CreateObjectActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
