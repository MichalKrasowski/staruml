...
public class StructuredActivityNode_ConditionalNodeCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public StructuredActivityNode_ConditionalNodeCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		UMLElementTypes.init_ConditionalNode_3092(newElement);
