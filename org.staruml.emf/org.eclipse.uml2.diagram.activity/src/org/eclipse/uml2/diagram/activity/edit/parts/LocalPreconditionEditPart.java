...
import org.eclipse.uml2.diagram.activity.edit.policies.LocalPreconditionCanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.LocalPreconditionItemSemanticEditPolicy;
...
public class LocalPreconditionEditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public LocalPreconditionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new LocalPreconditionItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new LocalPreconditionCanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		LocalPreconditionFigure figure = new LocalPreconditionFigure();
	 ...
	 * @generated
	 */
	public LocalPreconditionFigure getPrimaryShape() {
		return (LocalPreconditionFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LocalPreconditionCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureLocalPreconditionFigure_Body();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((LocalPreconditionCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof LocalPreconditionCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureLocalPreconditionFigure_Body();
			pane.remove(((LocalPreconditionCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof LocalPreconditionCompartmentEditPart) {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == UMLElementTypes.LiteralString_3049) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(LocalPreconditionCompartmentEditPart.VISUAL_ID));
			}
		}
	 ...
	 * @generated
	 */
	public class LocalPreconditionFigure extends ConstraintFigure {

		/**
		 * @generated
		 */
		private RectangleFigure fFigureLocalPreconditionFigure_Body;
		...
		public LocalPreconditionFigure() {
			...
			this.setFixedLabelText("\u00ABlocalPrecondition\u00BB");
