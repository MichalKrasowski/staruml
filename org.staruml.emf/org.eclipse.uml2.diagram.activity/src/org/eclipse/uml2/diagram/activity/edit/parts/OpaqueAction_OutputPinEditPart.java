...
import org.eclipse.uml2.diagram.activity.edit.policies.OpaqueAction_OutputPinCanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.OpaqueAction_OutputPinItemSemanticEditPolicy;
...
public class OpaqueAction_OutputPinEditPart extends BorderedBorderItemEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public OpaqueAction_OutputPinEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new OpaqueAction_OutputPinItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new OpaqueAction_OutputPinCanonicalEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof OpaqueAction_OutputPinNameEditPart || borderItemEditPart instanceof OpaqueAction_OutputPinOrderingEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(OpaqueAction_OutputPinNameEditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.OpaqueAction_OutputPinEditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
