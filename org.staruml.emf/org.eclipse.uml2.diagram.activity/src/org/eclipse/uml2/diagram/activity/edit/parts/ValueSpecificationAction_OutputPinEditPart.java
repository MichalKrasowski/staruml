...
import org.eclipse.uml2.diagram.activity.edit.policies.ValueSpecificationAction_OutputPinCanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.ValueSpecificationAction_OutputPinItemSemanticEditPolicy;
...
public class ValueSpecificationAction_OutputPinEditPart extends BorderedBorderItemEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public ValueSpecificationAction_OutputPinEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ValueSpecificationAction_OutputPinItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ValueSpecificationAction_OutputPinCanonicalEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ValueSpecificationAction_OutputPinNameEditPart || borderItemEditPart instanceof ValueSpecificationAction_OutputPinOrderingEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ValueSpecificationAction_OutputPinNameEditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.ValueSpecificationAction_OutputPinEditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
