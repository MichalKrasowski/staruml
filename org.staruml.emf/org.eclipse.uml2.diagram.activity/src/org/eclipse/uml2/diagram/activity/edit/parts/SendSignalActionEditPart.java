...
public class SendSignalActionEditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof SendSignalActionStereotypeEditPart) {
			((SendSignalActionStereotypeEditPart) childEditPart).setLabel(getPrimaryShape().getFigureSendSignalActionFigure_stereo());
			return true;
		}
		return false;
	}
	...
	public class SendSignalActionFigure extends Shape {
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureSendSignalActionFigure_name() {
		 ...
		 * @generated
		 */
		public StereotypeLabel2 getFigureSendSignalActionFigure_stereo() {
	...
	protected void addSemanticListeners() {
		...
		for (IUpdaterNodeDescriptor next : getSendSignalAction_3053ContainedLinks()) {
	...
	private List<IUpdaterLinkDescriptor> getSendSignalAction_3053ContainedLinks() {
		return UMLDiagramUpdater.getSendSignalAction_3053ContainedLinks(getNotationView());
	}
	...
	protected EditPart chooseLabelEditPartForDirectEditRequest(Request request) {
		if (request.getExtendedData().containsKey(RequestConstants.REQ_DIRECTEDIT_EXTENDEDDATA_INITIAL_CHAR)) {
			...
			if (initialChar.charValue() == '<') {
				EditPart result = getChildBySemanticHint(UMLVisualIDRegistry.getType(SendSignalActionStereotypeEditPart.VISUAL_ID));
				if (result != null) {
					return result;
				}
			}
