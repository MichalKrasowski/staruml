...
public class CallAction_InputPinItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public CallAction_InputPinItemSemanticEditPolicy() {
		super(UMLElementTypes.InputPin_3007);
	}
