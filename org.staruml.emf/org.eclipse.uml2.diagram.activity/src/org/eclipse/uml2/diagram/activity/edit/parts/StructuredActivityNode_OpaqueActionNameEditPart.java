...
public class StructuredActivityNode_OpaqueActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StructuredActivityNode_OpaqueActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.OpaqueAction_3011, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.StructuredActivityNode_OpaqueActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			StructuredActivityNode_OpaqueActionEditPart parent = (StructuredActivityNode_OpaqueActionEditPart) getParent();
			StructuredActivityNode_OpaqueActionStereotypeEditPart stereoLabel = (StructuredActivityNode_OpaqueActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(StructuredActivityNode_OpaqueActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
