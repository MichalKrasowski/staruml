...
public class AcceptEventActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AcceptEventActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.AcceptEventAction_3030, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.AcceptEventActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			AcceptEventActionEditPart parent = (AcceptEventActionEditPart) getParent();
			AcceptEventActionStereotypeEditPart stereoLabel = (AcceptEventActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(AcceptEventActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
