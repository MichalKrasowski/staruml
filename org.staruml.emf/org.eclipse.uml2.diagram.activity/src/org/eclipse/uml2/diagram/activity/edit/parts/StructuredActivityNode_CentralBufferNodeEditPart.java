...
import org.eclipse.uml2.diagram.activity.edit.policies.StructuredActivityNode_CentralBufferNodeCanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.StructuredActivityNode_CentralBufferNodeItemSemanticEditPolicy;
...
public class StructuredActivityNode_CentralBufferNodeEditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public StructuredActivityNode_CentralBufferNodeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StructuredActivityNode_CentralBufferNodeItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new StructuredActivityNode_CentralBufferNodeCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof StructuredActivityNode_CentralBufferNodeInStateEditPart) {
			((StructuredActivityNode_CentralBufferNodeInStateEditPart) childEditPart).setLabel(getPrimaryShape().getFigureCentralBufferFigure_states());
			return true;
		}
		if (childEditPart instanceof StructuredActivityNode_CentralBufferNodeStereotypeEditPart) {
			((StructuredActivityNode_CentralBufferNodeStereotypeEditPart) childEditPart).setLabel(getPrimaryShape().getFigureCentralBufferFigure_stereo());
			return true;
		}
		return false;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof StructuredActivityNode_CentralBufferNodeOrderingEditPart) {
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.StructuredActivityNode_CentralBufferNodeEditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
