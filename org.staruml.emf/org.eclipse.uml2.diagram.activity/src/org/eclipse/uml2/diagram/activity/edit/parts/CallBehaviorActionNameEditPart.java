...
public class CallBehaviorActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CallBehaviorAction_3044, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.CallBehaviorActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			CallBehaviorActionEditPart parent = (CallBehaviorActionEditPart) getParent();
			CallBehaviorActionStereotypeEditPart stereoLabel = (CallBehaviorActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(CallBehaviorActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
