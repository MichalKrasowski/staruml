...
public class ActivityPartition_DataStoreNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActivityPartition_DataStoreNodeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.DataStoreNode_3065, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.ActivityPartition_DataStoreNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			ActivityPartition_DataStoreNodeEditPart parent = (ActivityPartition_DataStoreNodeEditPart) getParent();
			ActivityPartition_DataStoreNodeStereotypeEditPart stereoLabel = (ActivityPartition_DataStoreNodeStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(ActivityPartition_DataStoreNodeStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
