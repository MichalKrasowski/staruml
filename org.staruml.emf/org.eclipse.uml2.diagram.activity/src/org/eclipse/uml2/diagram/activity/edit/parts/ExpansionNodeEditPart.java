...
import org.eclipse.uml2.diagram.activity.edit.policies.ExpansionNodeCanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.ExpansionNodeItemSemanticEditPolicy;
...
public class ExpansionNodeEditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ExpansionNodeItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ExpansionNodeCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ExpansionNodeNameEditPart) {
			((ExpansionNodeNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureObjectNodeFigure_name());
			return true;
		}
		if (childEditPart instanceof ExpansionNodeInStateEditPart) {
			((ExpansionNodeInStateEditPart) childEditPart).setLabel(getPrimaryShape().getFigureObjectNodeFigure_states());
			return true;
		}
		if (childEditPart instanceof ExpansionNodeStereotypeEditPart) {
			((ExpansionNodeStereotypeEditPart) childEditPart).setLabel(getPrimaryShape().getFigureObjectNodeFigure_stereo());
			return true;
		}
		return false;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ExpansionNodeOrderingEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ExpansionNodeNameEditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.ExpansionNodeEditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
	...
	public class ObjectNodeFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private Label fFigureObjectNodeFigure_name;

		/**
		 * @generated
		 */
		private Label fFigureObjectNodeFigure_states;

		/**
		 * @generated
		 */
		private Label fFigureObjectNodeFigure_stereo;
		...
		private void createContents() {
			...
			RectangleFigure objectNodeFigure_NameContainer0 = new RectangleFigure();
			objectNodeFigure_NameContainer0.setFill(false);
			objectNodeFigure_NameContainer0.setOutline(false);
			objectNodeFigure_NameContainer0.setLineWidth(1);

			this.add(objectNodeFigure_NameContainer0);

			ToolbarLayout layoutObjectNodeFigure_NameContainer0 = new ToolbarLayout();
			layoutObjectNodeFigure_NameContainer0.setStretchMinorAxis(false);
			layoutObjectNodeFigure_NameContainer0.setMinorAlignment(ToolbarLayout.ALIGN_CENTER);

			layoutObjectNodeFigure_NameContainer0.setSpacing(0);
			layoutObjectNodeFigure_NameContainer0.setVertical(true);

			objectNodeFigure_NameContainer0.setLayoutManager(layoutObjectNodeFigure_NameContainer0);

			fFigureObjectNodeFigure_stereo = new Label();
			fFigureObjectNodeFigure_stereo.setText("");

			objectNodeFigure_NameContainer0.add(fFigureObjectNodeFigure_stereo);

			fFigureObjectNodeFigure_name = new Label();
			fFigureObjectNodeFigure_name.setText("");

			objectNodeFigure_NameContainer0.add(fFigureObjectNodeFigure_name);

			fFigureObjectNodeFigure_states = new Label();
			fFigureObjectNodeFigure_states.setText("");

			objectNodeFigure_NameContainer0.add(fFigureObjectNodeFigure_states);
		 ...
		 * @generated
		 */
		public Label getFigureObjectNodeFigure_states() {
			return fFigureObjectNodeFigure_states;
		}

		/**
		 * @generated
		 */
		public Label getFigureObjectNodeFigure_stereo() {
			return fFigureObjectNodeFigure_stereo;
		}
