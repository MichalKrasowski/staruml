...
public class ExceptionHandlerLink_fixed_iconEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ExceptionHandlerLink_fixed_iconEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ExceptionHandler_4005, getParserElement(), CommonParserHint.DESCRIPTION);
		}
		return parser;
	}
