...
public class OpaqueActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.OpaqueAction_3029, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.OpaqueActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			OpaqueActionEditPart parent = (OpaqueActionEditPart) getParent();
			OpaqueActionStereotypeEditPart stereoLabel = (OpaqueActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(OpaqueActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
