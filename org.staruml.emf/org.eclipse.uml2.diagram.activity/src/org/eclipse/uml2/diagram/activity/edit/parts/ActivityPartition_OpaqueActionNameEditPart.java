...
public class ActivityPartition_OpaqueActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActivityPartition_OpaqueActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.OpaqueAction_3067, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.ActivityPartition_OpaqueActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			ActivityPartition_OpaqueActionEditPart parent = (ActivityPartition_OpaqueActionEditPart) getParent();
			ActivityPartition_OpaqueActionStereotypeEditPart stereoLabel = (ActivityPartition_OpaqueActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(ActivityPartition_OpaqueActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
