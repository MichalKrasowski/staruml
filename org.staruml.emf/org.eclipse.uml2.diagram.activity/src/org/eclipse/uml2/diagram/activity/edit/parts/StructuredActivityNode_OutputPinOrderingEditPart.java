...
public class StructuredActivityNode_OutputPinOrderingEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.StructuredActivityNode_OutputPinOrderingEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public StructuredActivityNode_OutputPinOrderingEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.OutputPin_3055, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.StructuredActivityNode_OutputPinOrderingEditPart.VISUAL_ID));
		}
		return parser;
	}
