...
public class ActivityPartition_CentralBufferNodeInStateEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActivityPartition_CentralBufferNodeInStateEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CentralBufferNode_3066, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.ActivityPartition_CentralBufferNodeInStateEditPart.VISUAL_ID));
		}
		return parser;
	}
