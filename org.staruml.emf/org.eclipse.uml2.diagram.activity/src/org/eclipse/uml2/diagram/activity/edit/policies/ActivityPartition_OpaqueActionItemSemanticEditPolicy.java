...
public class ActivityPartition_OpaqueActionItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ActivityPartition_OpaqueActionItemSemanticEditPolicy() {
		super(UMLElementTypes.OpaqueAction_3067);
	}
