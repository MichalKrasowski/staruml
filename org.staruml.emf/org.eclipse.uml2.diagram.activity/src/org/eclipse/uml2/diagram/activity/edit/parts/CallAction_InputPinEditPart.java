...
import org.eclipse.uml2.diagram.activity.edit.policies.CallAction_InputPinCanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.CallAction_InputPinItemSemanticEditPolicy;
...
public class CallAction_InputPinEditPart extends BorderedBorderItemEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public CallAction_InputPinEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CallAction_InputPinItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CallAction_InputPinCanonicalEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof CallAction_InputPinNameEditPart || borderItemEditPart instanceof CallAction_InputPinOrderingEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(CallAction_InputPinNameEditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.CallAction_InputPinEditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
