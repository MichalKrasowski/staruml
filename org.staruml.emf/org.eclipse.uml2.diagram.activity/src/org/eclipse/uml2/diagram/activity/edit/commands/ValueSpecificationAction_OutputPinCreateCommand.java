...
public class ValueSpecificationAction_OutputPinCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public ValueSpecificationAction_OutputPinCreateCommand(CreateElementRequest req) {
	...
	public boolean canExecute() {
		ValueSpecificationAction container = (ValueSpecificationAction) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		UMLElementTypes.init_OutputPin_3090(newElement);
