...
public class ActivityPartition_MergeNodeItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ActivityPartition_MergeNodeItemSemanticEditPolicy() {
		super(UMLElementTypes.MergeNode_3063);
	}
