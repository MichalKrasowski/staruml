...
public class CallAction_OutputPinItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public CallAction_OutputPinItemSemanticEditPolicy() {
		super(UMLElementTypes.OutputPin_3006);
	}
