...
public class StructuredActivityNode_CreateObjectActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StructuredActivityNode_CreateObjectActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CreateObjectAction_3018, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.StructuredActivityNode_CreateObjectActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			StructuredActivityNode_CreateObjectActionEditPart parent = (StructuredActivityNode_CreateObjectActionEditPart) getParent();
			StructuredActivityNode_CreateObjectActionStereotypeEditPart stereoLabel = (StructuredActivityNode_CreateObjectActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(StructuredActivityNode_CreateObjectActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
