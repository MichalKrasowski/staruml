...
public class DataStoreNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DataStoreNodeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.DataStoreNode_3036, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.DataStoreNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			DataStoreNodeEditPart parent = (DataStoreNodeEditPart) getParent();
			DataStoreNodeStereotypeEditPart stereoLabel = (DataStoreNodeStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(DataStoreNodeStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
