...
public class CallOperationAction_InputPinOrderingEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.CallOperationAction_InputPinOrderingEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public CallOperationAction_InputPinOrderingEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InputPin_3008, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.CallOperationAction_InputPinOrderingEditPart.VISUAL_ID));
		}
		return parser;
	}
