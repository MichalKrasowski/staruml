...
public class ValueSpecificationActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ValueSpecificationActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ValueSpecificationAction_3089, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.ValueSpecificationActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			ValueSpecificationActionEditPart parent = (ValueSpecificationActionEditPart) getParent();
			ValueSpecificationActionStereotypeEditPart stereoLabel = (ValueSpecificationActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(ValueSpecificationActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
