...
public class StructuredActivityNode_InputPinNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StructuredActivityNode_InputPinNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InputPin_3054, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.StructuredActivityNode_InputPinNameEditPart.VISUAL_ID));
		}
		return parser;
	}
