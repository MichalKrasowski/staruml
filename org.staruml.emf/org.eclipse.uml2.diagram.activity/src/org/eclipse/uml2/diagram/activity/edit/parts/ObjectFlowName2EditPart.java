...
public class ObjectFlowName2EditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.ObjectFlowName2EditPart.VISUAL_ID), new Point(0, 60));
	}

	/**
	 * @generated
	 */
	public ObjectFlowName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ObjectFlow_4002, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.ObjectFlowName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	private boolean isVisibleByPreferences() {
		return DiagramIconStylePreferenceHelper.shouldShowLabel(ObjectFlowName2EditPart.VISUAL_ID, getDiagramPreferencesHint());
	}
