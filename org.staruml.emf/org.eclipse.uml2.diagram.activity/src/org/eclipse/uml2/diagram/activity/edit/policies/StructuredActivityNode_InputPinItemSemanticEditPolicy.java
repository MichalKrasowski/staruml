...
public class StructuredActivityNode_InputPinItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public StructuredActivityNode_InputPinItemSemanticEditPolicy() {
		super(UMLElementTypes.InputPin_3054);
	}
