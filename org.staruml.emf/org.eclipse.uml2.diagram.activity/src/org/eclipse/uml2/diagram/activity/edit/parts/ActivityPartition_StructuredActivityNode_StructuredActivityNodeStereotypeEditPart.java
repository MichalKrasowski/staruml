...
public class ActivityPartition_StructuredActivityNode_StructuredActivityNodeStereotypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActivityPartition_StructuredActivityNode_StructuredActivityNodeStereotypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.StructuredActivityNode_3079, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.ActivityPartition_StructuredActivityNode_StructuredActivityNodeStereotypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			ActivityPartition_StructuredActivityNode_StructuredActivityNodeEditPart parent = (ActivityPartition_StructuredActivityNode_StructuredActivityNodeEditPart) getParent();
			StructuredActivityNodeQualifiedName2EditPart stereoLabel = (StructuredActivityNodeQualifiedName2EditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(StructuredActivityNodeQualifiedName2EditPart.VISUAL_ID));
			if (stereoLabel != null) {
