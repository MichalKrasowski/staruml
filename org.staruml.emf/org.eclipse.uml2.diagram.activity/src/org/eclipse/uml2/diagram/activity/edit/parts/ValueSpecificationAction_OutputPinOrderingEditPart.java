...
public class ValueSpecificationAction_OutputPinOrderingEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.ValueSpecificationAction_OutputPinOrderingEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public ValueSpecificationAction_OutputPinOrderingEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.OutputPin_3090, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.ValueSpecificationAction_OutputPinOrderingEditPart.VISUAL_ID));
		}
		return parser;
	}
