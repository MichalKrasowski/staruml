...
public class ActivityPartition_DataStoreNodeCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public ActivityPartition_DataStoreNodeCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResultGen(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		UMLElementTypes.init_DataStoreNode_3065(newElement);
