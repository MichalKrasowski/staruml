...
public class OpaqueAction_OutputPinItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public OpaqueAction_OutputPinItemSemanticEditPolicy() {
		super(UMLElementTypes.OutputPin_3001);
	}
