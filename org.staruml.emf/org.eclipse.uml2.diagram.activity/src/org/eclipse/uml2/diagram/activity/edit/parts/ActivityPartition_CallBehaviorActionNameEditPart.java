...
public class ActivityPartition_CallBehaviorActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActivityPartition_CallBehaviorActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CallBehaviorAction_3074, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.ActivityPartition_CallBehaviorActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			ActivityPartition_CallBehaviorActionEditPart parent = (ActivityPartition_CallBehaviorActionEditPart) getParent();
			ActivityPartition_CallBehaviorActionStereotypeEditPart stereoLabel = (ActivityPartition_CallBehaviorActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(ActivityPartition_CallBehaviorActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
