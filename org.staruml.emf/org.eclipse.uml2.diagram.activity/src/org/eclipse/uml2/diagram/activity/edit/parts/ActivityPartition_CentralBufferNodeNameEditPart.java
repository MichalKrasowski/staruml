...
public class ActivityPartition_CentralBufferNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActivityPartition_CentralBufferNodeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CentralBufferNode_3066, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.ActivityPartition_CentralBufferNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			ActivityPartition_CentralBufferNodeEditPart parent = (ActivityPartition_CentralBufferNodeEditPart) getParent();
			ActivityPartition_CentralBufferNodeStereotypeEditPart stereoLabel = (ActivityPartition_CentralBufferNodeStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(ActivityPartition_CentralBufferNodeStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
