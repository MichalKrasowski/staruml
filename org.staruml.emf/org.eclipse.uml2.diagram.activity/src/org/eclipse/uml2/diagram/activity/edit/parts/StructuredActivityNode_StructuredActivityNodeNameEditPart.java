...
public class StructuredActivityNode_StructuredActivityNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StructuredActivityNode_StructuredActivityNodeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.StructuredActivityNode_3009, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.StructuredActivityNode_StructuredActivityNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			StructuredActivityNode_StructuredActivityNodeEditPart parent = (StructuredActivityNode_StructuredActivityNodeEditPart) getParent();
			StructuredActivityNode_StructuredActivityNodeStereotypeEditPart stereoLabel = (StructuredActivityNode_StructuredActivityNodeStereotypeEditPart) parent
					.getChildBySemanticHint(UMLVisualIDRegistry.getType(StructuredActivityNode_StructuredActivityNodeStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
