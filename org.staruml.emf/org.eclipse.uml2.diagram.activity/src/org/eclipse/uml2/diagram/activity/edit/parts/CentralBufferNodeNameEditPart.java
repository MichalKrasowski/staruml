...
public class CentralBufferNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CentralBufferNodeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CentralBufferNode_3037, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.CentralBufferNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			CentralBufferNodeEditPart parent = (CentralBufferNodeEditPart) getParent();
			CentralBufferNodeStereotypeEditPart stereoLabel = (CentralBufferNodeStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(CentralBufferNodeStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
