...
public class ActivityPartition_CallOperationActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActivityPartition_CallOperationActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CallOperationAction_3075, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.ActivityPartition_CallOperationActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			ActivityPartition_CallOperationActionEditPart parent = (ActivityPartition_CallOperationActionEditPart) getParent();
			ActivityPartition_CallOperationActionStereotypeEditPart stereoLabel = (ActivityPartition_CallOperationActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(ActivityPartition_CallOperationActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
