...
public class ActivityPartition_InitialNodeItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ActivityPartition_InitialNodeItemSemanticEditPolicy() {
		super(UMLElementTypes.InitialNode_3064);
	}
