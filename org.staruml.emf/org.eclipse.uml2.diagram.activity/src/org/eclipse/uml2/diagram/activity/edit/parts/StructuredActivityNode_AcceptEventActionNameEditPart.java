...
public class StructuredActivityNode_AcceptEventActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StructuredActivityNode_AcceptEventActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.AcceptEventAction_3012, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.StructuredActivityNode_AcceptEventActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			StructuredActivityNode_AcceptEventActionEditPart parent = (StructuredActivityNode_AcceptEventActionEditPart) getParent();
			StructuredActivityNode_AcceptEventActionStereotypeEditPart stereoLabel = (StructuredActivityNode_AcceptEventActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(StructuredActivityNode_AcceptEventActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
