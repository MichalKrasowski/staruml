...
import org.eclipse.uml2.diagram.activity.edit.policies.ActivityPartition_CentralBufferNodeCanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.ActivityPartition_CentralBufferNodeItemSemanticEditPolicy;
...
public class ActivityPartition_CentralBufferNodeEditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public ActivityPartition_CentralBufferNodeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ActivityPartition_CentralBufferNodeItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ActivityPartition_CentralBufferNodeCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ActivityPartition_CentralBufferNodeNameEditPart) {
			((ActivityPartition_CentralBufferNodeNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureCentralBufferFigure_name());
			return true;
		}
		if (childEditPart instanceof ActivityPartition_CentralBufferNodeInStateEditPart) {
			((ActivityPartition_CentralBufferNodeInStateEditPart) childEditPart).setLabel(getPrimaryShape().getFigureCentralBufferFigure_states());
			return true;
		}
		if (childEditPart instanceof ActivityPartition_CentralBufferNodeStereotypeEditPart) {
			((ActivityPartition_CentralBufferNodeStereotypeEditPart) childEditPart).setLabel(getPrimaryShape().getFigureCentralBufferFigure_stereo());
			return true;
		}
		return false;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ActivityPartition_CentralBufferNodeOrderingEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ActivityPartition_CentralBufferNodeNameEditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.ActivityPartition_CentralBufferNodeEditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
	...
	protected EditPart chooseLabelEditPartForDirectEditRequest(Request request) {
		if (request.getExtendedData().containsKey(RequestConstants.REQ_DIRECTEDIT_EXTENDEDDATA_INITIAL_CHAR)) {
			...
			if (initialChar.charValue() == '<') {
				EditPart result = getChildBySemanticHint(UMLVisualIDRegistry.getType(ActivityPartition_CentralBufferNodeStereotypeEditPart.VISUAL_ID));
				if (result != null) {
					return result;
				}
			}
