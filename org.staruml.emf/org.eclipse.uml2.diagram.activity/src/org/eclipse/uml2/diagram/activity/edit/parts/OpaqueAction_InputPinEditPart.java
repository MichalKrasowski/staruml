...
import org.eclipse.uml2.diagram.activity.edit.policies.OpaqueAction_InputPinCanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.OpaqueAction_InputPinItemSemanticEditPolicy;
...
public class OpaqueAction_InputPinEditPart extends BorderedBorderItemEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public OpaqueAction_InputPinEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new OpaqueAction_InputPinItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new OpaqueAction_InputPinCanonicalEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof OpaqueAction_InputPinNameEditPart || borderItemEditPart instanceof OpaqueAction_InputPinOrderingEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(OpaqueAction_InputPinNameEditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.OpaqueAction_InputPinEditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
