...
public class AddStructuralFeatureValueActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.AddStructuralFeatureValueAction_3043, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.AddStructuralFeatureValueActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			AddStructuralFeatureValueActionEditPart parent = (AddStructuralFeatureValueActionEditPart) getParent();
			AddStructuralFeatureValueActionStereotypeEditPart stereoLabel = (AddStructuralFeatureValueActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(AddStructuralFeatureValueActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
