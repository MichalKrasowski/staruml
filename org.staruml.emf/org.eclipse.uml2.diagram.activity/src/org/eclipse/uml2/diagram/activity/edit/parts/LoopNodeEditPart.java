...
import org.eclipse.uml2.diagram.activity.edit.policies.LoopNodeCanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.LoopNodeItemSemanticEditPolicy;
...
public class LoopNodeEditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new LoopNodeCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof LoopNodeStereotypeEditPart) {
			((LoopNodeStereotypeEditPart) childEditPart).setLabel(getPrimaryShape().getFigureStructuredActivityFigure_stereo());
			return true;
		}
		if (childEditPart instanceof LoopNodeContentPaneCompartmentEditPart) {
			...
			pane.add(((LoopNodeContentPaneCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof LoopNodeContentPaneCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureStructuredActivityFigure_ContentPane();
			pane.remove(((LoopNodeContentPaneCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.LoopNodeEditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
	...
	protected void addSemanticListeners() {
		...
		for (IUpdaterNodeDescriptor next : getLoopNode_3058ContainedLinks()) {
	...
	private List<IUpdaterLinkDescriptor> getLoopNode_3058ContainedLinks() {
		return UMLDiagramUpdater.getLoopNode_3058ContainedLinks(getNotationView());
	}
