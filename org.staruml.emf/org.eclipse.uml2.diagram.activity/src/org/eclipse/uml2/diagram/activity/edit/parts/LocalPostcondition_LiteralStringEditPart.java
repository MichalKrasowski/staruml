...
import org.eclipse.uml2.diagram.activity.edit.policies.LocalPostcondition_LiteralStringItemSemanticEditPolicy;
...
public class LocalPostcondition_LiteralStringEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LocalPostcondition_LiteralStringEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new LocalPostcondition_LiteralStringItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.LiteralString_3051, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.LocalPostcondition_LiteralStringEditPart.VISUAL_ID));
		}
		return parser;
	}
