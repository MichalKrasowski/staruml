...
public class StructuredActivityNode_ForkNodeItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public StructuredActivityNode_ForkNodeItemSemanticEditPolicy() {
		super(UMLElementTypes.ForkNode_3021);
	}
