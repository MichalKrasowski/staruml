...
public class AddStructuralFeatureValueAction_insertAt_InputPinCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public AddStructuralFeatureValueAction_insertAt_InputPinCreateCommand(CreateElementRequest req) {
