...
public class ActivityPartition_CreateObjectActionCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public ActivityPartition_CreateObjectActionCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResultGen(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		UMLElementTypes.init_CreateObjectAction_3072(newElement);
