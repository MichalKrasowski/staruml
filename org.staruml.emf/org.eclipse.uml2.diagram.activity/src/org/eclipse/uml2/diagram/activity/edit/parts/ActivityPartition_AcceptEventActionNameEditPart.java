...
public class ActivityPartition_AcceptEventActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActivityPartition_AcceptEventActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.AcceptEventAction_3059, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.ActivityPartition_AcceptEventActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			ActivityPartition_AcceptEventActionEditPart parent = (ActivityPartition_AcceptEventActionEditPart) getParent();
			ActivityPartition_AcceptEventActionStereotypeEditPart stereoLabel = (ActivityPartition_AcceptEventActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(ActivityPartition_AcceptEventActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
