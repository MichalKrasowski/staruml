...
public class CreateObjectActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CreateObjectAction_3042, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.CreateObjectActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			CreateObjectActionEditPart parent = (CreateObjectActionEditPart) getParent();
			CreateObjectActionStereotypeEditPart stereoLabel = (CreateObjectActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(CreateObjectActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
