...
import org.eclipse.uml2.diagram.activity.edit.policies.ConditionalNodeCompartmentCanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.ConditionalNodeCompartmentItemSemanticEditPolicy;
...
public class ConditionalNodeCompartmentEditPart extends ShapeCompartmentEditPart {
	 ...
	 * @generated
	 */
	public ConditionalNodeCompartmentEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.ConditionalNodeCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ConditionalNodeCompartmentCanonicalEditPolicy());
