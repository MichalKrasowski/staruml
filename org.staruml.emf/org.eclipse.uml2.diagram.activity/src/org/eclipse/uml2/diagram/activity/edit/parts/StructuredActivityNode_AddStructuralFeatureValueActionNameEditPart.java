...
public class StructuredActivityNode_AddStructuralFeatureValueActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StructuredActivityNode_AddStructuralFeatureValueActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.AddStructuralFeatureValueAction_3023, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.StructuredActivityNode_AddStructuralFeatureValueActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			StructuredActivityNode_AddStructuralFeatureValueActionEditPart parent = (StructuredActivityNode_AddStructuralFeatureValueActionEditPart) getParent();
			StructuredActivityNode_AddStructuralFeatureValueActionStereotypeEditPart stereoLabel = (StructuredActivityNode_AddStructuralFeatureValueActionStereotypeEditPart) parent
					.getChildBySemanticHint(UMLVisualIDRegistry.getType(StructuredActivityNode_AddStructuralFeatureValueActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
