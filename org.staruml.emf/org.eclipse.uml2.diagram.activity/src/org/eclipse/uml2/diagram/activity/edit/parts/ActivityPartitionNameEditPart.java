...
public class ActivityPartitionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public void setLabel(RotatedImageOfString figure) {
		unregisterVisuals();
		setFigure(figure);
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ActivityPartition_3056, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.ActivityPartitionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
