...
public class CreateObjectAction_OutputPinItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public CreateObjectAction_OutputPinItemSemanticEditPolicy() {
		super(UMLElementTypes.OutputPin_3002);
	}
