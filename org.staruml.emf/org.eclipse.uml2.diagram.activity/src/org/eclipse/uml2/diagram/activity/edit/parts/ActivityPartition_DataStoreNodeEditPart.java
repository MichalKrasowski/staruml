...
import org.eclipse.uml2.diagram.activity.edit.policies.ActivityPartition_DataStoreNodeCanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.ActivityPartition_DataStoreNodeItemSemanticEditPolicy;
...
public class ActivityPartition_DataStoreNodeEditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public ActivityPartition_DataStoreNodeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ActivityPartition_DataStoreNodeItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ActivityPartition_DataStoreNodeCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ActivityPartition_DataStoreNodeNameEditPart) {
			((ActivityPartition_DataStoreNodeNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureDataStoreFigure_name());
			return true;
		}
		if (childEditPart instanceof ActivityPartition_DataStoreNodeInStateEditPart) {
			((ActivityPartition_DataStoreNodeInStateEditPart) childEditPart).setLabel(getPrimaryShape().getFigureDataStoreFigure_states());
			return true;
		}
		if (childEditPart instanceof ActivityPartition_DataStoreNodeStereotypeEditPart) {
			((ActivityPartition_DataStoreNodeStereotypeEditPart) childEditPart).setLabel(getPrimaryShape().getFigureDataStoreFigure_stereo());
			return true;
		}
		return false;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ActivityPartition_DataStoreNodeOrderingEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ActivityPartition_DataStoreNodeNameEditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.ActivityPartition_DataStoreNodeEditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
	...
	protected EditPart chooseLabelEditPartForDirectEditRequest(Request request) {
		if (request.getExtendedData().containsKey(RequestConstants.REQ_DIRECTEDIT_EXTENDEDDATA_INITIAL_CHAR)) {
			...
			if (initialChar.charValue() == '<') {
				EditPart result = getChildBySemanticHint(UMLVisualIDRegistry.getType(ActivityPartition_DataStoreNodeStereotypeEditPart.VISUAL_ID));
				if (result != null) {
					return result;
				}
			}
