...
public class StructuredActivityNode_CallBehaviorActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StructuredActivityNode_CallBehaviorActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CallBehaviorAction_3019, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.StructuredActivityNode_CallBehaviorActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			StructuredActivityNode_CallBehaviorActionEditPart parent = (StructuredActivityNode_CallBehaviorActionEditPart) getParent();
			StructuredActivityNode_CallBehaviorActionStereotypeEditPart stereoLabel = (StructuredActivityNode_CallBehaviorActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(StructuredActivityNode_CallBehaviorActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
