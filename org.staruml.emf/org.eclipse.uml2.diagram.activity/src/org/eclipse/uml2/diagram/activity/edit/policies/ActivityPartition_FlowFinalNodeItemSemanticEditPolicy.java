...
public class ActivityPartition_FlowFinalNodeItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ActivityPartition_FlowFinalNodeItemSemanticEditPolicy() {
		super(UMLElementTypes.FlowFinalNode_3068);
	}
