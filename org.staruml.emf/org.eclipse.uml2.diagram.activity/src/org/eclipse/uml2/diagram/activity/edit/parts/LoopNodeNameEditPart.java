...
public class LoopNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LoopNodeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.LoopNode_3058, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.LoopNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			LoopNodeEditPart parent = (LoopNodeEditPart) getParent();
			LoopNodeStereotypeEditPart stereoLabel = (LoopNodeStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(LoopNodeStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
