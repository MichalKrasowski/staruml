...
public class ControlFlowName3EditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.ControlFlowName3EditPart.VISUAL_ID), new Point(0, 80));
	}

	/**
	 * @generated
	 */
	public ControlFlowName3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ControlFlow_4001, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.ControlFlowName3EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	private boolean isVisibleByPreferences() {
		return DiagramIconStylePreferenceHelper.shouldShowLabel(ControlFlowName3EditPart.VISUAL_ID, getDiagramPreferencesHint());
	}
