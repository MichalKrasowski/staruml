...
public class ActivityPartition_CallBehaviorActionItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ActivityPartition_CallBehaviorActionItemSemanticEditPolicy() {
		super(UMLElementTypes.CallBehaviorAction_3074);
	}
