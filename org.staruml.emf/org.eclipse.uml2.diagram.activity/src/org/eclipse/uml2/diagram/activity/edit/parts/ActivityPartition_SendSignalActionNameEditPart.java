...
public class ActivityPartition_SendSignalActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActivityPartition_SendSignalActionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.SendSignalAction_3077, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.ActivityPartition_SendSignalActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			ActivityPartition_SendSignalActionEditPart parent = (ActivityPartition_SendSignalActionEditPart) getParent();
			ActivityPartition_SendSignalActionStereotypeEditPart stereoLabel = (ActivityPartition_SendSignalActionStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(ActivityPartition_SendSignalActionStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
