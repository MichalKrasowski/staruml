...
public class ActivityPartition_DecisionNodeCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public ActivityPartition_DecisionNodeCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResultGen(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		UMLElementTypes.init_DecisionNode_3062(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(DecisionNode newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
