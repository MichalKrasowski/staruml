...
import org.eclipse.uml2.diagram.sequence.edit.policies.StateInvariantItemSemanticEditPolicy;
...
public class StateInvariantEditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof StateInvariantLabelEditPart) {
			((StateInvariantLabelEditPart) childEditPart).setLabel(getPrimaryShape().getStateInvariantInplaceLabel());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(StateInvariantLabelEditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.sequence.edit.parts.StateInvariantEditPart) {
			types.add(UMLElementTypes.Message_4001);
		}
