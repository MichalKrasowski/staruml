...
import org.eclipse.uml2.diagram.sequence.edit.policies.LayeredInteractionUseItemSemanticEditPolicy;
...
import org.eclipse.uml2.diagram.sequence.frame.InteractionUseShape;
...
public class LayeredInteractionUseEditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public LayeredInteractionUseEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new LayeredInteractionUseItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		CustomInteractionUseFigure figure = new CustomInteractionUseFigure();
	 ...
	 * @generated
	 */
	public CustomInteractionUseFigure getPrimaryShape() {
		return (CustomInteractionUseFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InteractionUseSignatureEditPart) {
			((InteractionUseSignatureEditPart) childEditPart).setLabel(getPrimaryShape().getReferencedInteractionSignatureLabel());
			return true;
		}
		return false;
	}
	...
	protected NodeFigure createNodePlate() {
		...
		if (primaryShape instanceof Frame) {
			result = new DefaultSizeNodeFigure(getMapMode().DPtoLP(50), getMapMode().DPtoLP(40)) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(InteractionUseSignatureEditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.sequence.edit.parts.LayeredInteractionUseEditPart) {
			types.add(UMLElementTypes.Message_4001);
		}
	 ...
	 * @generated
	 */
	public class CustomInteractionUseFigure extends InteractionUseShape {

		/**
		 * @generated
		 */
		public CustomInteractionUseFigure() {

			this.setPentagonLabelText("ref");
		...
		public Label getReferencedInteractionSignatureLabel() {
			return super.getReferencedInteractionSignatureLabel();
		}
