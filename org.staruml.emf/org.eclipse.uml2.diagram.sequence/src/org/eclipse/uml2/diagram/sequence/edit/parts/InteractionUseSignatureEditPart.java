...
public class InteractionUseSignatureEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public InteractionUseSignatureEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InteractionUse_3007, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.sequence.edit.parts.InteractionUseSignatureEditPart.VISUAL_ID));
		}
		return parser;
	}
