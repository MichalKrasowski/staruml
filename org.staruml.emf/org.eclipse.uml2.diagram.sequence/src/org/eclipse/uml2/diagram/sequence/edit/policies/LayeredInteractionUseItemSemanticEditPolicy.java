...
public class LayeredInteractionUseItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public LayeredInteractionUseItemSemanticEditPolicy() {
		super(UMLElementTypes.InteractionUse_3007);
	}
