...
public class InteractionOperandMountingRegionEditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public InteractionOperandMountingRegionEditPart(View view) {
		super(view);
	}
