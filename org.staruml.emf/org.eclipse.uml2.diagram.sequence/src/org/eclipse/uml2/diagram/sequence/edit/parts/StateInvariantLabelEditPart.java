...
public class StateInvariantLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.StateInvariant_3003, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.sequence.edit.parts.StateInvariantLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
