...
public class LifelineRefLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LifelineRefLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Lifeline_3001, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.sequence.edit.parts.LifelineRefLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
