...
public class InteractionUseMountingRegionItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public InteractionUseMountingRegionItemSemanticEditPolicy() {
		super(UMLElementTypes.InteractionUse_3006);
	}
