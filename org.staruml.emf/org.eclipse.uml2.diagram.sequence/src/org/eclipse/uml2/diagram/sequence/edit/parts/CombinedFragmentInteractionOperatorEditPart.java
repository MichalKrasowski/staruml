...
public class CombinedFragmentInteractionOperatorEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CombinedFragment_3008, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.sequence.edit.parts.CombinedFragmentInteractionOperatorEditPart.VISUAL_ID));
		}
		return parser;
	}
