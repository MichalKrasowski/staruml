...
public class ActionExecutionLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActionExecutionLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ActionExecutionSpecification_3002, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.sequence.edit.parts.ActionExecutionLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
