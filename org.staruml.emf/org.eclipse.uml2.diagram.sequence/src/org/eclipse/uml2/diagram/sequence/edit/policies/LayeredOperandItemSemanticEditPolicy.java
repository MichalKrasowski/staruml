...
public class LayeredOperandItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public LayeredOperandItemSemanticEditPolicy() {
		super(UMLElementTypes.InteractionOperand_3009);
	}
