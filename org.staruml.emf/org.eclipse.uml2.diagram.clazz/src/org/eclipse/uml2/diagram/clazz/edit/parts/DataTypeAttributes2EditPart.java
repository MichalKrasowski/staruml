...
import org.eclipse.uml2.diagram.clazz.edit.policies.DataTypeAttributes2CanonicalEditPolicy;
import org.eclipse.uml2.diagram.clazz.edit.policies.DataTypeAttributes2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DataTypeAttributes2EditPart extends ListCompartmentEditPart implements IInsertableEditPart {
	 ...
	 * @generated
	 */
	public DataTypeAttributes2EditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.DataTypeAttributes2EditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DataTypeAttributes2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(UMLVisualIDRegistry.TYPED_ADAPTER));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new DataTypeAttributes2CanonicalEditPolicy());
