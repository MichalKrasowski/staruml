 ...
 * @generated
 */
public class DependencyEditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof DependencyNameEditPart) {
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.clazz.edit.parts.DependencyEditPart) {
			types.add(UMLElementTypes.Dependency_4002);
		}
	...
	private void handleFeatureLinkModification(Notification event) {
		...
		if (event.getFeature() == UMLPackage.eINSTANCE.getDependency_Client()) {
			guardedRefreshDiagram();
			return;
		}
	}
