...
public class AssociationStereotypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AssociationStereotypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Association_4005, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.AssociationStereotypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	private boolean isVisibleByPreferences() {
		return DiagramIconStylePreferenceHelper.shouldShowLabel(AssociationStereotypeEditPart.VISUAL_ID, getDiagramPreferencesHint());
	}
