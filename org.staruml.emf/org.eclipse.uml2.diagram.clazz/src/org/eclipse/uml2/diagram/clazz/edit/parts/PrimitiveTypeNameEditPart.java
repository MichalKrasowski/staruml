...
public class PrimitiveTypeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.PrimitiveType_2005, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.PrimitiveTypeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			PrimitiveType2EditPart parent = (PrimitiveType2EditPart) getParent();
			PrimitiveTypeStereotypeEditPart stereoLabel = (PrimitiveTypeStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(PrimitiveTypeStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
