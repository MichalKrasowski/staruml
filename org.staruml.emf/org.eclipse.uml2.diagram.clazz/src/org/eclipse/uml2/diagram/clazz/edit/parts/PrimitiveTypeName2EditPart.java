...
public class PrimitiveTypeName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.PrimitiveType_3037, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.PrimitiveTypeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			PrimitiveType3EditPart parent = (PrimitiveType3EditPart) getParent();
			PrimitiveTypeStereotype2EditPart stereoLabel = (PrimitiveTypeStereotype2EditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(PrimitiveTypeStereotype2EditPart.VISUAL_ID));
			if (stereoLabel != null) {
