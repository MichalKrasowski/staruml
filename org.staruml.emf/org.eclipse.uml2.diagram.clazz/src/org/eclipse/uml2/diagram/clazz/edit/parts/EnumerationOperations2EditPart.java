...
import org.eclipse.uml2.diagram.clazz.edit.policies.EnumerationOperations2CanonicalEditPolicy;
import org.eclipse.uml2.diagram.clazz.edit.policies.EnumerationOperations2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EnumerationOperations2EditPart extends ListCompartmentEditPart implements IInsertableEditPart {
	 ...
	 * @generated
	 */
	public EnumerationOperations2EditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.EnumerationOperations2EditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EnumerationOperations2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(UMLVisualIDRegistry.TYPED_ADAPTER));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new EnumerationOperations2CanonicalEditPolicy());
