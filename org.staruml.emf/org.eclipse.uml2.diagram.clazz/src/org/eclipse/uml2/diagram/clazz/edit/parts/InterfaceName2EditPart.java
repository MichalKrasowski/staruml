...
public class InterfaceName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Interface_2013, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.InterfaceName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			Interface2EditPart parent = (Interface2EditPart) getParent();
			InterfaceStereotypeEditPart stereoLabel = (InterfaceStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(InterfaceStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
