 ...
 * @generated
 */
public class Enumeration2EditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EnumerationStereotypeEditPart) {
			((EnumerationStereotypeEditPart) childEditPart).setLabel(getPrimaryShape().getFigureClassFigure_StereoLabel());
			return true;
		}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.clazz.edit.parts.Enumeration2EditPart) {
			types.add(UMLElementTypes.Generalization_4001);
		}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == UMLElementTypes.Property_3023) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(EnumerationAttributesEditPart.VISUAL_ID));
			}
			if (type == UMLElementTypes.Operation_3024) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(EnumerationOperationsEditPart.VISUAL_ID));
			}
		}
	...
	protected EditPart chooseLabelEditPartForDirectEditRequest(Request request) {
		if (request.getExtendedData().containsKey(RequestConstants.REQ_DIRECTEDIT_EXTENDEDDATA_INITIAL_CHAR)) {
			...
			if (initialChar.charValue() == '<') {
				EditPart result = getChildBySemanticHint(UMLVisualIDRegistry.getType(EnumerationStereotypeEditPart.VISUAL_ID));
				if (result != null) {
					return result;
				}
			}
