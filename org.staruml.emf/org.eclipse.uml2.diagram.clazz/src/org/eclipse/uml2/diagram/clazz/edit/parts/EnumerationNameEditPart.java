...
public class EnumerationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Enumeration_2003, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.EnumerationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			Enumeration2EditPart parent = (Enumeration2EditPart) getParent();
			EnumerationStereotypeEditPart stereoLabel = (EnumerationStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(EnumerationStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
