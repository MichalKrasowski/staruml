 ...
 * @generated
 */
public class TemplateSignatureNode_signatureEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TemplateSignatureNode_signatureEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.RedefinableTemplateSignature_3027, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.TemplateSignatureNode_signatureEditPart.VISUAL_ID));
		}
		return parser;
	}
