...
import org.eclipse.uml2.diagram.clazz.edit.policies.DataType3CanonicalEditPolicy;
import org.eclipse.uml2.diagram.clazz.edit.policies.DataType3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DataType3EditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public DataType3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DataType3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new DataType3CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DataTypeName2EditPart) {
			((DataTypeName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureClassFigure_NameLabel());
			return true;
		}
		if (childEditPart instanceof DataTypeStereotype2EditPart) {
			((DataTypeStereotype2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureClassFigure_StereoLabel());
			return true;
		}
		if (childEditPart instanceof DataTypeAttributes2EditPart) {
			...
			pane.add(((DataTypeAttributes2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof DataTypeOperations2EditPart) {
			IFigure pane = getPrimaryShape().getFigureClassFigure_OperationsCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((DataTypeOperations2EditPart) childEditPart).getFigure());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof DataTypeAttributes2EditPart) {
			IFigure pane = getPrimaryShape().getFigureClassFigure_PropertiesCompartment();
			pane.remove(((DataTypeAttributes2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof DataTypeOperations2EditPart) {
			IFigure pane = getPrimaryShape().getFigureClassFigure_OperationsCompartment();
			pane.remove(((DataTypeOperations2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof RedefinableTemplateSignatureEditPart) {
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof DataTypeAttributes2EditPart) {
			return getPrimaryShape().getFigureClassFigure_PropertiesCompartment();
		}
		if (editPart instanceof DataTypeOperations2EditPart) {
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.clazz.edit.parts.DataType3EditPart) {
			types.add(UMLElementTypes.Generalization_4001);
		}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == UMLElementTypes.Property_3014) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(DataTypeAttributes2EditPart.VISUAL_ID));
			}
			if (type == UMLElementTypes.Operation_3015) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(DataTypeOperations2EditPart.VISUAL_ID));
			}
		}
	...
	protected void addSemanticListeners() {
		...
		for (IUpdaterNodeDescriptor next : getDataType_3036ContainedLinks()) {
	...
	private List<IUpdaterLinkDescriptor> getDataType_3036ContainedLinks() {
		return UMLDiagramUpdater.getDataType_3036ContainedLinks(getNotationView());
	}
	...
	protected EditPart chooseLabelEditPartForDirectEditRequest(Request request) {
		if (request.getExtendedData().containsKey(RequestConstants.REQ_DIRECTEDIT_EXTENDEDDATA_INITIAL_CHAR)) {
			...
			if (initialChar.charValue() == '<') {
				EditPart result = getChildBySemanticHint(UMLVisualIDRegistry.getType(DataTypeStereotype2EditPart.VISUAL_ID));
				if (result != null) {
					return result;
				}
			}
