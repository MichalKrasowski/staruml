...
public class TemplateParameterSubstitutionEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.TemplateBinding_4016, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.TemplateParameterSubstitutionEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	private boolean isVisibleByPreferences() {
		return DiagramIconStylePreferenceHelper.shouldShowLabel(TemplateParameterSubstitutionEditPart.VISUAL_ID, getDiagramPreferencesHint());
	}
