...
public class GeneralizationStereotype2EditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.clazz.edit.parts.GeneralizationStereotype2EditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public GeneralizationStereotype2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Generalization_4011, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.GeneralizationStereotype2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	private boolean isVisibleByPreferences() {
		return DiagramIconStylePreferenceHelper.shouldShowLabel(GeneralizationStereotype2EditPart.VISUAL_ID, getDiagramPreferencesHint());
	}
