...
public class TurnIntoInstanceSpecification2Action extends ChangeNotationAction {
	 ...
	 * @generated
	 */
	public TurnIntoInstanceSpecification2Action(IWorkbenchPage workbenchPage, String actionId) {
	...
	protected void updateText() {
		setText(Messages.TurnIntoInstanceSpecification2Action_text);
		setText(Messages.TurnIntoInstanceSpecification2Action_tooltiptext);
	}
