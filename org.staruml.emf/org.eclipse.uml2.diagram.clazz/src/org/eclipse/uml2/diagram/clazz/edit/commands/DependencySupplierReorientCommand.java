 ...
 * @generated
 */
public class DependencySupplierReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public DependencySupplierReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getSuppliers().remove(getOldTarget());
		getNewSource().getSuppliers().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getSuppliers().remove(getOldTarget());
		getOldSource().getSuppliers().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
