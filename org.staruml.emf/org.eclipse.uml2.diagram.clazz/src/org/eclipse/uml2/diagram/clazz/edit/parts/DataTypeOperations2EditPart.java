...
import org.eclipse.uml2.diagram.clazz.edit.policies.DataTypeOperations2CanonicalEditPolicy;
import org.eclipse.uml2.diagram.clazz.edit.policies.DataTypeOperations2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DataTypeOperations2EditPart extends ListCompartmentEditPart implements IInsertableEditPart {
	 ...
	 * @generated
	 */
	public DataTypeOperations2EditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.DataTypeOperations2EditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DataTypeOperations2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(UMLVisualIDRegistry.TYPED_ADAPTER));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new DataTypeOperations2CanonicalEditPolicy());
