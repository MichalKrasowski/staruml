...
public class InterfaceStereotypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public InterfaceStereotypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Interface_2013, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.InterfaceStereotypeEditPart.VISUAL_ID));
		}
		return parser;
	}
