...
import org.eclipse.uml2.diagram.clazz.edit.policies.EnumerationLiterals2CanonicalEditPolicy;
import org.eclipse.uml2.diagram.clazz.edit.policies.EnumerationLiterals2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EnumerationLiterals2EditPart extends ListCompartmentEditPart implements IInsertableEditPart {
	 ...
	 * @generated
	 */
	public EnumerationLiterals2EditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.EnumerationLiterals2EditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EnumerationLiterals2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(UMLVisualIDRegistry.TYPED_ADAPTER));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new EnumerationLiterals2CanonicalEditPolicy());
