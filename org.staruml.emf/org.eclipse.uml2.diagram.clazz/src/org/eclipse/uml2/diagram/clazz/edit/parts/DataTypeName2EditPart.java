...
public class DataTypeName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.DataType_3036, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.DataTypeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			DataType3EditPart parent = (DataType3EditPart) getParent();
			DataTypeStereotype2EditPart stereoLabel = (DataTypeStereotype2EditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(DataTypeStereotype2EditPart.VISUAL_ID));
			if (stereoLabel != null) {
