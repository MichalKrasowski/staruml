...
public class InstanceSpecificationStereoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public InstanceSpecificationStereoEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InstanceSpecification_2008, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.InstanceSpecificationStereoEditPart.VISUAL_ID));
		}
		return parser;
	}
