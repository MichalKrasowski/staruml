...
public class InterfaceContributionItemProvider extends AbstractContributionItemProvider implements IProvider {
	...
	protected IAction createAction(String actionId, IWorkbenchPartDescriptor partDescriptor) {
		...
		if (TurnIntoInterface2Action.ACTION_ID.equals(actionId)) {
			return new TurnIntoInterface2Action(workbenchPage, actionId);
		}
	 ...
	 * @generated
	 */
	public static final String MENU_LABEL = Messages.InterfaceContributionItemProvider_menu;
	 ...
	 * @generated
	 */
	public static final String GROUP_LABEL = Messages.InterfaceContributionItemProvider_group;
}
