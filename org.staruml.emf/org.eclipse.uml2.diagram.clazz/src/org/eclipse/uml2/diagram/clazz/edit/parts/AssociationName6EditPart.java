...
public class AssociationName6EditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.clazz.edit.parts.AssociationName6EditPart.VISUAL_ID), new Point(0, 15));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Association_4005, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.AssociationName6EditPart.VISUAL_ID));
		}
		return parser;
	}
