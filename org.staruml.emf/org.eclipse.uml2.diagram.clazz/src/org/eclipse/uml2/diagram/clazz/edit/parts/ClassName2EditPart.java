...
public class ClassName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Class_3033, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.clazz.edit.parts.ClassName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			Class5EditPart parent = (Class5EditPart) getParent();
			ClassStereotype2EditPart stereoLabel = (ClassStereotype2EditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(ClassStereotype2EditPart.VISUAL_ID));
			if (stereoLabel != null) {
