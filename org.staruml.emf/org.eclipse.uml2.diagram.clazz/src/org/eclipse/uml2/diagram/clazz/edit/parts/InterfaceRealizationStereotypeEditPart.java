...
public class InterfaceRealizationStereotypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.clazz.edit.parts.InterfaceRealizationStereotypeEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public InterfaceRealizationStereotypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InterfaceRealization_4008, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.InterfaceRealizationStereotypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	private boolean isVisibleByPreferences() {
		return DiagramIconStylePreferenceHelper.shouldShowLabel(InterfaceRealizationStereotypeEditPart.VISUAL_ID, getDiagramPreferencesHint());
	}
