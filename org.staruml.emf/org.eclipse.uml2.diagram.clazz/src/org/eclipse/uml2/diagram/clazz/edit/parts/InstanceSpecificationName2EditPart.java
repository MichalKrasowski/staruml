...
public class InstanceSpecificationName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InstanceSpecification_3035, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.InstanceSpecificationName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			InstanceSpecification3EditPart parent = (InstanceSpecification3EditPart) getParent();
			InstanceSpecificationStereo2EditPart stereoLabel = (InstanceSpecificationStereo2EditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(InstanceSpecificationStereo2EditPart.VISUAL_ID));
			if (stereoLabel != null) {
