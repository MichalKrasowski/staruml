...
public class DataTypeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.DataType_2004, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.DataTypeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			DataType2EditPart parent = (DataType2EditPart) getParent();
			DataTypeStereotypeEditPart stereoLabel = (DataTypeStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(DataTypeStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
