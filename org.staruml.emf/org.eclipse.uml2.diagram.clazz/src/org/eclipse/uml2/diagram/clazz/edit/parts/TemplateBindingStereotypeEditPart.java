...
public class TemplateBindingStereotypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TemplateBindingStereotypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.TemplateBinding_4016, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.TemplateBindingStereotypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	private boolean isVisibleByPreferences() {
		return DiagramIconStylePreferenceHelper.shouldShowLabel(TemplateBindingStereotypeEditPart.VISUAL_ID, getDiagramPreferencesHint());
	}
