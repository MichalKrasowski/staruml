 ...
 * @generated
 */
public class TemplateBinding_BindLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.clazz.edit.parts.TemplateBinding_BindLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public TemplateBinding_BindLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.TemplateBinding_4016, getParserElement(), CommonParserHint.DESCRIPTION);
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new TemplateBinding_BindLabel();
	}

	/**
	 * @generated
	 */
	public class TemplateBinding_BindLabel extends Label {

		/**
		 * @generated
		 */
		public TemplateBinding_BindLabel() {
			this.setText("<<bind>>");
		}
	...
	private boolean isVisibleByPreferences() {
		return DiagramIconStylePreferenceHelper.shouldShowLabel(TemplateBinding_BindLabelEditPart.VISUAL_ID, getDiagramPreferencesHint());
	}
