...
import org.eclipse.uml2.diagram.clazz.edit.policies.AssociationClass2CanonicalEditPolicy;
 ...
 * @generated
 */
public class AssociationClass2EditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.clazz.edit.parts.AssociationClass2EditPart) {
			types.add(UMLElementTypes.Generalization_4001);
		}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == UMLElementTypes.Property_3019) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(AssociationClassAttributesEditPart.VISUAL_ID));
			}
			if (type == UMLElementTypes.Operation_3020) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(AssociationClassOperationsEditPart.VISUAL_ID));
			}
			if (type == UMLElementTypes.Class_3003) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(AssociationClassClassesEditPart.VISUAL_ID));
			}
		}
	...
	protected void addSemanticListeners() {
		...
		for (IUpdaterNodeDescriptor next : getAssociationClass_2007ContainedLinks()) {
	...
	private List<IUpdaterLinkDescriptor> getAssociationClass_2007ContainedLinks() {
		return UMLDiagramUpdater.getAssociationClass_2007ContainedLinks(getNotationView());
	}
	...
	protected EditPart chooseLabelEditPartForDirectEditRequest(Request request) {
		if (request.getExtendedData().containsKey(RequestConstants.REQ_DIRECTEDIT_EXTENDEDDATA_INITIAL_CHAR)) {
			...
			if (initialChar.charValue() == '<') {
				EditPart result = getChildBySemanticHint(UMLVisualIDRegistry.getType(AssociationClassStereotypeEditPart.VISUAL_ID));
				if (result != null) {
					return result;
				}
			}
