...
public class ClassNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Class_2001, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.clazz.edit.parts.ClassNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			Class2EditPart parent = (Class2EditPart) getParent();
			ClassStereotypeEditPart stereoLabel = (ClassStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(ClassStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
