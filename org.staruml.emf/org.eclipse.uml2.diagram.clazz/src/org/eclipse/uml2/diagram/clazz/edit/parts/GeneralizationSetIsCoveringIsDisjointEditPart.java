 ...
 * @generated
 */
public class GeneralizationSetIsCoveringIsDisjointEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.clazz.edit.parts.GeneralizationSetIsCoveringIsDisjointEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public GeneralizationSetIsCoveringIsDisjointEditPart(View view) {
		super(view);
	}
