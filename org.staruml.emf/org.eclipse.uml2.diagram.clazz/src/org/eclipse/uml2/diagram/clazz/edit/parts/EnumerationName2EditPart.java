...
public class EnumerationName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Enumeration_3034, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.EnumerationName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			Enumeration3EditPart parent = (Enumeration3EditPart) getParent();
			EnumerationStereotype2EditPart stereoLabel = (EnumerationStereotype2EditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(EnumerationStereotype2EditPart.VISUAL_ID));
			if (stereoLabel != null) {
