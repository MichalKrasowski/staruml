...
public class Interface3ItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public Interface3ItemSemanticEditPolicy() {
		super(UMLElementTypes.Interface_3041);
	}
