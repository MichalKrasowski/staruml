 ...
 * @generated
 */
public class GeneralizationSetNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.clazz.edit.parts.GeneralizationSetNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public GeneralizationSetNameEditPart(View view) {
		super(view);
	}
	...
	protected EObject getParserElement() {
		...
		if (element instanceof GeneralizationSet) {
			element = ((GeneralizationSet) element).getPowertype();
		}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.GeneralizationSet_2012, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.GeneralizationSetNameEditPart.VISUAL_ID));
		}
		return parser;
	}
