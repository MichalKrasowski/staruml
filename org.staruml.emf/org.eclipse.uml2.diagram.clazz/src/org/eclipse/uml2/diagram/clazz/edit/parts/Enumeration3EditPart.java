...
import org.eclipse.uml2.diagram.clazz.edit.policies.Enumeration3CanonicalEditPolicy;
import org.eclipse.uml2.diagram.clazz.edit.policies.Enumeration3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Enumeration3EditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public Enumeration3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Enumeration3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new Enumeration3CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EnumerationName2EditPart) {
			((EnumerationName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureClassFigure_NameLabel());
			return true;
		}
		if (childEditPart instanceof EnumerationStereotype2EditPart) {
			((EnumerationStereotype2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureClassFigure_StereoLabel());
			return true;
		}
		if (childEditPart instanceof EnumerationLiterals2EditPart) {
			IFigure pane = getPrimaryShape().getFigureClassFigure_LiteralsCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((EnumerationLiterals2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof EnumerationAttributes2EditPart) {
			IFigure pane = getPrimaryShape().getFigureClassFigure_PropertiesCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((EnumerationAttributes2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof EnumerationOperations2EditPart) {
			IFigure pane = getPrimaryShape().getFigureClassFigure_OperationsCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((EnumerationOperations2EditPart) childEditPart).getFigure());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EnumerationLiterals2EditPart) {
			IFigure pane = getPrimaryShape().getFigureClassFigure_LiteralsCompartment();
			pane.remove(((EnumerationLiterals2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof EnumerationAttributes2EditPart) {
			IFigure pane = getPrimaryShape().getFigureClassFigure_PropertiesCompartment();
			pane.remove(((EnumerationAttributes2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof EnumerationOperations2EditPart) {
			IFigure pane = getPrimaryShape().getFigureClassFigure_OperationsCompartment();
			pane.remove(((EnumerationOperations2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof RedefinableTemplateSignatureEditPart) {
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof EnumerationLiterals2EditPart) {
			return getPrimaryShape().getFigureClassFigure_LiteralsCompartment();
		}
		if (editPart instanceof EnumerationAttributes2EditPart) {
			return getPrimaryShape().getFigureClassFigure_PropertiesCompartment();
		}
		if (editPart instanceof EnumerationOperations2EditPart) {
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.clazz.edit.parts.Enumeration3EditPart) {
			types.add(UMLElementTypes.Generalization_4001);
		}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == UMLElementTypes.EnumerationLiteral_3016) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(EnumerationLiterals2EditPart.VISUAL_ID));
			}
			if (type == UMLElementTypes.Property_3023) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(EnumerationAttributes2EditPart.VISUAL_ID));
			}
			if (type == UMLElementTypes.Operation_3024) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(EnumerationOperations2EditPart.VISUAL_ID));
			}
		}
	...
	protected void addSemanticListeners() {
		...
		for (IUpdaterNodeDescriptor next : getEnumeration_3034ContainedLinks()) {
	...
	private List<IUpdaterLinkDescriptor> getEnumeration_3034ContainedLinks() {
		return UMLDiagramUpdater.getEnumeration_3034ContainedLinks(getNotationView());
	}
	...
	protected EditPart chooseLabelEditPartForDirectEditRequest(Request request) {
		if (request.getExtendedData().containsKey(RequestConstants.REQ_DIRECTEDIT_EXTENDEDDATA_INITIAL_CHAR)) {
			...
			if (initialChar.charValue() == '<') {
				EditPart result = getChildBySemanticHint(UMLVisualIDRegistry.getType(EnumerationStereotype2EditPart.VISUAL_ID));
				if (result != null) {
					return result;
				}
			}
