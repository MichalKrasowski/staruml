...
import org.eclipse.uml2.diagram.clazz.edit.policies.ElementImportItemSemanticEditPolicy;
...
public class ElementImportEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ElementImport_3031, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.ElementImportEditPart.VISUAL_ID));
		}
		return parser;
	}
