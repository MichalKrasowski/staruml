...
public class AssociationClassNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.AssociationClass_2007, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.clazz.edit.parts.AssociationClassNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			AssociationClass2EditPart parent = (AssociationClass2EditPart) getParent();
			AssociationClassStereotypeEditPart stereoLabel = (AssociationClassStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(AssociationClassStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
