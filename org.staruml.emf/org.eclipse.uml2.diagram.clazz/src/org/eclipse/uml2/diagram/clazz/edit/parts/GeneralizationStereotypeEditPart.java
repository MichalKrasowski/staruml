...
public class GeneralizationStereotypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.clazz.edit.parts.GeneralizationStereotypeEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public GeneralizationStereotypeEditPart(View view) {
		super(view);
	}
	...
	private boolean isVisibleByPreferences() {
		return DiagramIconStylePreferenceHelper.shouldShowLabel(GeneralizationStereotypeEditPart.VISUAL_ID, getDiagramPreferencesHint());
	}
