 ...
 * @generated
 */
public class ExecutionEnvironmentName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ExecutionEnvironmentName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ExecutionEnvironment_3005, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.deploy.edit.parts.ExecutionEnvironmentName2EditPart.VISUAL_ID));
		}
		return parser;
	}
