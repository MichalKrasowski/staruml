...
import org.eclipse.uml2.diagram.deploy.edit.policies.DeploymentSpecificationProperties2ItemSemanticEditPolicy;
...
public class DeploymentSpecificationProperties2EditPart extends ListCompartmentEditPart implements IInsertableEditPart {
	 ...
	 * @generated
	 */
	public DeploymentSpecificationProperties2EditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.DeploymentSpecificationProperties2EditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DeploymentSpecificationProperties2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(UMLVisualIDRegistry.TYPED_ADAPTER));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new DeploymentSpecificationProperties2CanonicalEditPolicy());
	...
	public IElementType getElementType() {
		return UMLElementTypes.Property_3003;
	}
