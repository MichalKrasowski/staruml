...
import org.eclipse.uml2.diagram.deploy.edit.policies.ExecutionEnvironment2CanonicalEditPolicy;
import org.eclipse.uml2.diagram.deploy.edit.policies.ExecutionEnvironment2GraphicalNodeEditPolicy;
import org.eclipse.uml2.diagram.deploy.edit.policies.ExecutionEnvironment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ExecutionEnvironment2EditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public ExecutionEnvironment2EditPart(View view) {
		super(view);
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ExecutionEnvironmentName2EditPart) {
		...
		if (childEditPart instanceof ExecutionEnvironmentArtifacts2EditPart) {
			...
			pane.add(((ExecutionEnvironmentArtifacts2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ExecutionEnvironmentArtifacts2EditPart) {
			IFigure pane = getPrimaryShape().getContentPane();
			pane.remove(((ExecutionEnvironmentArtifacts2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ExecutionEnvironmentArtifacts2EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ExecutionEnvironmentName2EditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.deploy.edit.parts.ExecutionEnvironment2EditPart) {
			types.add(UMLElementTypes.CommunicationPath_4004);
		}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == UMLElementTypes.Artifact_3006) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ExecutionEnvironmentArtifacts2EditPart.VISUAL_ID));
			}
		}
	...
	protected void addSemanticListeners() {
		...
		for (IUpdaterNodeDescriptor next : getExecutionEnvironment_3005ContainedLinks()) {
	...
	private List<IUpdaterLinkDescriptor> getExecutionEnvironment_3005ContainedLinks() {
		return UMLDiagramUpdater.getExecutionEnvironment_3005ContainedLinks(getNotationView());
	}
