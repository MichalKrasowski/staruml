...
public class DeploymentSpecificationName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DeploymentSpecificationName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.DeploymentSpecification_3009, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.deploy.edit.parts.DeploymentSpecificationName2EditPart.VISUAL_ID));
		}
		return parser;
	}
