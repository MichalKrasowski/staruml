...
public class DeploymentSpecificationStereo3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DeploymentSpecificationStereo3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.DeploymentSpecification_2007, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.deploy.edit.parts.DeploymentSpecificationStereo3EditPart.VISUAL_ID));
		}
		return parser;
	}
