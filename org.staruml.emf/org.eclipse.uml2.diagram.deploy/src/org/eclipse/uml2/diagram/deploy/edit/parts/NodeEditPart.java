...
public class NodeEditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.deploy.edit.parts.NodeEditPart) {
			types.add(UMLElementTypes.CommunicationPath_4004);
		}
	...
	protected void addSemanticListeners() {
		...
		for (IUpdaterNodeDescriptor next : getNode_2004ContainedLinks()) {
	...
	private List<IUpdaterLinkDescriptor> getNode_2004ContainedLinks() {
		return UMLDiagramUpdater.getNode_2004ContainedLinks(getNotationView());
	}
