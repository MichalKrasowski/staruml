...
public class ExecutionEnvironmentStereoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ExecutionEnvironmentStereoEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ExecutionEnvironment_2005, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.deploy.edit.parts.ExecutionEnvironmentStereoEditPart.VISUAL_ID));
		}
		return parser;
	}
