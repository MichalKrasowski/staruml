...
public class ExecutionEnvironmentStereo2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ExecutionEnvironmentStereo2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ExecutionEnvironment_3005, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.deploy.edit.parts.ExecutionEnvironmentStereo2EditPart.VISUAL_ID));
		}
		return parser;
	}
