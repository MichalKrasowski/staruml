...
public class DeploymentSpecificationStereo4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DeploymentSpecificationStereo4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.DeploymentSpecification_3009, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.deploy.edit.parts.DeploymentSpecificationStereo4EditPart.VISUAL_ID));
		}
		return parser;
	}
