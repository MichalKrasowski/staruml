...
public class NodeStereoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NodeStereoEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Node_2004, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.deploy.edit.parts.NodeStereoEditPart.VISUAL_ID));
		}
		return parser;
	}
