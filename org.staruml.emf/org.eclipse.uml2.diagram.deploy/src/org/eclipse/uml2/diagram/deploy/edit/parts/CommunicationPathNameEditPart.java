 ...
 * @generated
 */
public class CommunicationPathNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.deploy.edit.parts.CommunicationPathNameEditPart.VISUAL_ID), new Point(0, 20));
	}

	/**
	 * @generated
	 */
	public CommunicationPathNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CommunicationPath_4004, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.deploy.edit.parts.CommunicationPathNameEditPart.VISUAL_ID));
		}
		return parser;
	}
