...
public class ManifestationNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.deploy.edit.parts.ManifestationNameEditPart.VISUAL_ID), new Point(0, 20));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Manifestation_4002, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.deploy.edit.parts.ManifestationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	private boolean isVisibleByPreferences() {
		return DiagramIconStylePreferenceHelper.shouldShowLabel(ManifestationNameEditPart.VISUAL_ID, getDiagramPreferencesHint());
	}
}
