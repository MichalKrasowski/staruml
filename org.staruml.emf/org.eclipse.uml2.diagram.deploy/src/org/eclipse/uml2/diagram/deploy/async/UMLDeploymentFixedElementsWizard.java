 ...
 * @generated
 */
public class UMLDeploymentFixedElementsWizard extends UMLNewDiagramFileWizard {
	 ...
	 * @generated
	 */
	public UMLDeploymentFixedElementsWizard(URI domainModelURI, EObject diagramRoot, PackageableElement[] toSelect, TransactionalEditingDomain editingDomain) {
	...
	private static class SyncModelNodeForInitializedDiagram extends SyncModelNode {
		...
		public void initWithDiagramView(View diagramView) {
			...
			setChecked(isInToCreateList() || UMLDeploymentDiagramHeaderFilter.SHARED_INSTANCE.isFilteredVisualId(this));
		}
