...
public class ForkPseudostateItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ForkPseudostateItemSemanticEditPolicy() {
		super(UMLElementTypes.Pseudostate_3007);
	}
