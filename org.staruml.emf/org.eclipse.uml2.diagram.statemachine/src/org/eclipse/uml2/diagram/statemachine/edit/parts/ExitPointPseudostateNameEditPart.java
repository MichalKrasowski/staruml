...
public class ExitPointPseudostateNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.statemachine.edit.parts.ExitPointPseudostateNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public ExitPointPseudostateNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Pseudostate_3015, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.statemachine.edit.parts.ExitPointPseudostateNameEditPart.VISUAL_ID));
		}
		return parser;
	}
