...
public class DeepHistoryPseudostateCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public DeepHistoryPseudostateCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		UMLElementTypes.init_Pseudostate_3006(newElement);
