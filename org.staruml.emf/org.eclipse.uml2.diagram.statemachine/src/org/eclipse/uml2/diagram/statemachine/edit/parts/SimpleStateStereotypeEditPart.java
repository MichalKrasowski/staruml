...
public class SimpleStateStereotypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SimpleStateStereotypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.State_3001, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.statemachine.edit.parts.SimpleStateStereotypeEditPart.VISUAL_ID));
		}
		return parser;
	}
