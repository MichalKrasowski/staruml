...
public class SubmachineStateNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.State_3016, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.statemachine.edit.parts.SubmachineStateNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			SubmachineStateEditPart parent = (SubmachineStateEditPart) getParent();
			SubmachineStateStereotypeEditPart stereoLabel = (SubmachineStateStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(SubmachineStateStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
