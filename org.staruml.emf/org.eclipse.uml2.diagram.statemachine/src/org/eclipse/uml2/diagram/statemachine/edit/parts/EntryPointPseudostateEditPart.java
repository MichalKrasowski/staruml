...
import org.eclipse.uml2.diagram.statemachine.edit.policies.EntryPointPseudostateItemSemanticEditPolicy;
...
public class EntryPointPseudostateEditPart extends BorderedBorderItemEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public EntryPointPseudostateEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EntryPointPseudostateItemSemanticEditPolicy());
	...
	protected void addBorderItemGen(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof EntryPointPseudostateNameEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(EntryPointPseudostateNameEditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.statemachine.edit.parts.EntryPointPseudostateEditPart) {
			types.add(UMLElementTypes.Transition_4001);
		}
