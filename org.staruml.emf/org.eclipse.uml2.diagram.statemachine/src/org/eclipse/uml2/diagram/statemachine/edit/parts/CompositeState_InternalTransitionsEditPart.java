...
import org.eclipse.uml2.diagram.statemachine.edit.policies.CompositeState_InternalTransitionsItemSemanticEditPolicy;
...
public class CompositeState_InternalTransitionsEditPart extends ListCompartmentEditPart implements IInsertableEditPart {
	 ...
	 * @generated
	 */
	public CompositeState_InternalTransitionsEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.CompositeState_InternalTransitionsEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CompositeState_InternalTransitionsItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(UMLVisualIDRegistry.TYPED_ADAPTER));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CompositeState_InternalTransitionsCanonicalEditPolicy());
