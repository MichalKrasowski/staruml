...
import org.eclipse.uml2.diagram.statemachine.edit.policies.CompositeState_InternalActivitiesCanonicalEditPolicy;
import org.eclipse.uml2.diagram.statemachine.edit.policies.CompositeState_InternalActivitiesItemSemanticEditPolicy;
...
public class CompositeState_InternalActivitiesEditPart extends ListCompartmentEditPart {
	 ...
	 * @generated
	 */
	public CompositeState_InternalActivitiesEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.CompositeState_InternalActivitiesEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CompositeState_InternalActivitiesItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(UMLVisualIDRegistry.TYPED_ADAPTER));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CompositeState_InternalActivitiesCanonicalEditPolicy());
