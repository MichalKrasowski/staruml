...
public class DeepHistoryPseudostateItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public DeepHistoryPseudostateItemSemanticEditPolicy() {
		super(UMLElementTypes.Pseudostate_3006);
	}
