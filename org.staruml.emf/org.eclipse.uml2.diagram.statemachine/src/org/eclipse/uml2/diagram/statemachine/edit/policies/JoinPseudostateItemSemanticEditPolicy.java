...
public class JoinPseudostateItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public JoinPseudostateItemSemanticEditPolicy() {
		super(UMLElementTypes.Pseudostate_3008);
	}
