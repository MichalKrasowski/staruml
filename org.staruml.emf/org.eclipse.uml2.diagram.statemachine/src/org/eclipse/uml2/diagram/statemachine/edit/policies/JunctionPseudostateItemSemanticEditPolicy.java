...
public class JunctionPseudostateItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public JunctionPseudostateItemSemanticEditPolicy() {
		super(UMLElementTypes.Pseudostate_3009);
	}
