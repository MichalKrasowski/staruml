...
public class TransitionNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.statemachine.edit.parts.TransitionNameEditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Transition_4001, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.statemachine.edit.parts.TransitionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
