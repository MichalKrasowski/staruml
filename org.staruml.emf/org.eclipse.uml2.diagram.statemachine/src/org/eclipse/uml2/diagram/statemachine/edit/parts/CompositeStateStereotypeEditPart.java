...
public class CompositeStateStereotypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CompositeStateStereotypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.State_3012, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.statemachine.edit.parts.CompositeStateStereotypeEditPart.VISUAL_ID));
		}
		return parser;
	}
