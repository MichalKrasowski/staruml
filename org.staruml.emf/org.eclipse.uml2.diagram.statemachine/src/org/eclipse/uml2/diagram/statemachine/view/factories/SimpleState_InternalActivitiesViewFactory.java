...
public class SimpleState_InternalActivitiesViewFactory extends BasicNodeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = UMLVisualIDRegistry.getType(SimpleState_InternalActivitiesEditPart.VISUAL_ID);
