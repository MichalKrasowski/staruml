...
public class EntryPointPseudostateItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public EntryPointPseudostateItemSemanticEditPolicy() {
		super(UMLElementTypes.Pseudostate_3014);
	}
