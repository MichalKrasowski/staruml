...
import org.eclipse.uml2.diagram.statemachine.edit.policies.InternalTransitionItemSemanticEditPolicy;
...
public class InternalTransitionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InternalTransitionItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Transition_3022, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.statemachine.edit.parts.InternalTransitionEditPart.VISUAL_ID));
		}
		return parser;
	}
