...
public class EntryConnectionPointReferenceCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public EntryConnectionPointReferenceCreateCommand(CreateElementRequest req) {
