...
public class TerminatePseudostateItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public TerminatePseudostateItemSemanticEditPolicy() {
		super(UMLElementTypes.Pseudostate_3011);
	}
