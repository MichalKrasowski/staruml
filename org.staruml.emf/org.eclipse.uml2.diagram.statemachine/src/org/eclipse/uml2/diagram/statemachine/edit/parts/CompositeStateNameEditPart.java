...
public class CompositeStateNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CompositeStateNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.State_3012, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.statemachine.edit.parts.CompositeStateNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			CompositeStateEditPart parent = (CompositeStateEditPart) getParent();
			CompositeStateStereotypeEditPart stereoLabel = (CompositeStateStereotypeEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(CompositeStateStereotypeEditPart.VISUAL_ID));
			if (stereoLabel != null) {
