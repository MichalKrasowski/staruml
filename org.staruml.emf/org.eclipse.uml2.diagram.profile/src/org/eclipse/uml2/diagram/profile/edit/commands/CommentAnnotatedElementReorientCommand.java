...
public class CommentAnnotatedElementReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return UMLBaseItemSemanticEditPolicy.LinkConstraints.canExistCommentAnnotatedElement_4004(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return UMLBaseItemSemanticEditPolicy.LinkConstraints.canExistCommentAnnotatedElement_4004(getOldSource(), getNewTarget());
	}
