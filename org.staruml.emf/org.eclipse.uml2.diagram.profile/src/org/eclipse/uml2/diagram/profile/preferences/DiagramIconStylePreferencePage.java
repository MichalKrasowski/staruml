...
public class DiagramIconStylePreferencePage extends IconStylePreferencePage {
	 ...
	 */
	static {
		ourConnectorLabels2Vids.put(Messages.DiagramIconStylePreferencePage_LinkLabelsFilter_ExtensionLabel_6001, ExtensionLink_requiredEditPart.VISUAL_ID);
	}
	...
	public static void initConnectorLabelDefaults(IPreferenceStore store) {
		for (Integer visualId : ourConnectorLabels2Vids.values()) {
			store.setDefault(org.eclipse.uml2.diagram.profile.preferences.DiagramIconStylePreferencePage.getConnectionLabelPreference(visualId), true);
		}
	}
