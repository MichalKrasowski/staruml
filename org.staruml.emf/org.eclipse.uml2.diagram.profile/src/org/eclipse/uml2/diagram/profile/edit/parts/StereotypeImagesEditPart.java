...
import org.eclipse.uml2.diagram.profile.edit.policies.StereotypeImagesCanonicalEditPolicy;
import org.eclipse.uml2.diagram.profile.edit.policies.StereotypeImagesItemSemanticEditPolicy;
...
public class StereotypeImagesEditPart extends ListCompartmentEditPart implements IInsertableEditPart {
	 ...
	 * @generated
	 */
	public StereotypeImagesEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.StereotypeImagesEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StereotypeImagesItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(UMLVisualIDRegistry.TYPED_ADAPTER));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new StereotypeImagesCanonicalEditPolicy());
	...
	public IElementType getElementType() {
		return UMLElementTypes.Image_3010;
	}
