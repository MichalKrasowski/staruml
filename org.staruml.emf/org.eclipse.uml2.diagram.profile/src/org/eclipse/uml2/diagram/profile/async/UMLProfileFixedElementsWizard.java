...
import org.eclipse.uml2.diagram.profile.part.UMLCreateShortcutAction;
 ...
 * @generated
 */
public class UMLProfileFixedElementsWizard extends UMLNewDiagramFileWizard {
	 ...
	 * @generated
	 */
	public UMLProfileFixedElementsWizard(URI domainModelURI, EObject diagramRoot, PackageableElement[] toSelect, TransactionalEditingDomain editingDomain) {
	...
	protected AbstractTransactionalCommand getApplySynchronizationCommand() {
		...
		mySyncHelper = new NewDiagramSyncHelperWithFixedElements(createSyncContext(semanticRoot), ProfileEditPart.MODEL_ID);
	...
	private static class SyncModelNodeForInitializedDiagram extends SyncModelNode {
		...
		public void initWithDiagramView(View diagramView) {
			...
			setChecked(isInToCreateList() || UMLProfileDiagramHeaderFilter.SHARED_INSTANCE.isFilteredVisualId(this));
		}
