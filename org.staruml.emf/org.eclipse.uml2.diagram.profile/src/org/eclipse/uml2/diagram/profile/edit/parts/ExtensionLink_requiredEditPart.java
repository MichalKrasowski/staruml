 ...
 * @generated
 */
public class ExtensionLink_requiredEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.profile.edit.parts.ExtensionLink_requiredEditPart.VISUAL_ID), new Point(0, -15));
	}

	/**
	 * @generated
	 */
	public ExtensionLink_requiredEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Extension_4002, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.profile.edit.parts.ExtensionLink_requiredEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new ExtensionPolyline_required();
	}
	...
	private boolean isVisibleByPreferences() {
		return DiagramIconStylePreferenceHelper.shouldShowLabel(ExtensionLink_requiredEditPart.VISUAL_ID, getDiagramPreferencesHint());
	}
