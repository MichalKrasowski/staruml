 ...
 * @generated
 */
public class ReferencedMetaclassNode_classNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ReferencedMetaclassNode_classNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ElementImport_2006, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.profile.edit.parts.ReferencedMetaclassNode_classNameEditPart.VISUAL_ID));
		}
		return parser;
	}
