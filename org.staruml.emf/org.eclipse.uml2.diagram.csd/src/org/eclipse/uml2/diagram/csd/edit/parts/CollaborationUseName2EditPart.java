 ...
 * @generated
 */
public class CollaborationUseName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CollaborationUseName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CollaborationUse_3002, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.csd.edit.parts.CollaborationUseName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			CollaborationUse2EditPart parent = (CollaborationUse2EditPart) getParent();
			CollaborationUseStereoEditPart stereoLabel = (CollaborationUseStereoEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(CollaborationUseStereoEditPart.VISUAL_ID));
			if (stereoLabel != null) {
