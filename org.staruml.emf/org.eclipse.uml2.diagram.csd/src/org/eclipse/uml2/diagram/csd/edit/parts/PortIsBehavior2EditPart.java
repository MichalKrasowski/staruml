 ...
 * @generated
 */
public class PortIsBehavior2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.csd.edit.parts.PortIsBehavior2EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public PortIsBehavior2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Port_3017, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.csd.edit.parts.PortIsBehavior2EditPart.VISUAL_ID));
		}
		return parser;
	}
