 ...
 * @generated
 */
public class CollaborationContentsEditPart extends ShapeCompartmentEditPart {
	 ...
	 * @generated
	 */
	public CollaborationContentsEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.CollaborationContentsEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CollaborationContentsItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CollaborationContentsCanonicalEditPolicy());
