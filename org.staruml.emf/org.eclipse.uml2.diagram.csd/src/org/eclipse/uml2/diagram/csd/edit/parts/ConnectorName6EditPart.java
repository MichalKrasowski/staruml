 ...
 * @generated
 */
public class ConnectorName6EditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.csd.edit.parts.ConnectorName6EditPart.VISUAL_ID), new Point(0, 15));
	}

	/**
	 * @generated
	 */
	public ConnectorName6EditPart(View view) {
		super(view);
	}
