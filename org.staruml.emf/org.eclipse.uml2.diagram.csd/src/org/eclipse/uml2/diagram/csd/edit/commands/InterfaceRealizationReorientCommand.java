...
public class InterfaceRealizationReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return UMLBaseItemSemanticEditPolicy.LinkConstraints.canExistInterfaceRealization_4007(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		BehavioredClassifier container = (BehavioredClassifier) getLink().eContainer();
		return UMLBaseItemSemanticEditPolicy.LinkConstraints.canExistInterfaceRealization_4007(container, source, getNewTarget());
	}
