...
public class ClassContributionItemProvider extends AbstractContributionItemProvider implements IProvider {
	...
	protected IAction createAction(String actionId, IWorkbenchPartDescriptor partDescriptor) {
		...
		if (TurnIntoClass3Action.ACTION_ID.equals(actionId)) {
			return new TurnIntoClass3Action(workbenchPage, actionId);
		}
	 ...
	 * @generated
	 */
	public static final String MENU_LABEL = Messages.ClassContributionItemProvider_menu;
	 ...
	 * @generated
	 */
	public static final String GROUP_LABEL = Messages.ClassContributionItemProvider_group;
}
