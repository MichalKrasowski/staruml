...
public class AssociationName2EditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.csd.edit.parts.AssociationName2EditPart.VISUAL_ID), new Point(0, -15));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Association_4011, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.csd.edit.parts.AssociationName2EditPart.VISUAL_ID));
		}
		return parser;
	}
