...
public class AssociationNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.csd.edit.parts.AssociationNameEditPart.VISUAL_ID), new Point(0, 20));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Association_4011, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.csd.edit.parts.AssociationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
