...
import org.eclipse.uml2.diagram.csd.part.UMLCreateShortcutAction;
 ...
 * @generated
 */
public class UMLCompositeStructuresFixedElementsWizard extends UMLNewDiagramFileWizard {
	 ...
	 * @generated
	 */
	public UMLCompositeStructuresFixedElementsWizard(URI domainModelURI, EObject diagramRoot, PackageableElement[] toSelect, TransactionalEditingDomain editingDomain) {
	...
	private static class SyncModelNodeForInitializedDiagram extends SyncModelNode {
		...
		public void initWithDiagramView(View diagramView) {
			...
			setChecked(isInToCreateList() || UMLCompositeStructuresDiagramHeaderFilter.SHARED_INSTANCE.isFilteredVisualId(this));
		}
