 ...
 * @generated
 */
public class PortIsBehaviorEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.csd.edit.parts.PortIsBehaviorEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public PortIsBehaviorEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		return UMLElementTypes.getImage(UMLPackage.eINSTANCE.getState());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Port_3011, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.csd.edit.parts.PortIsBehaviorEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new BehaviorPort_state();
	}

	/**
	 * @generated
	 */
	public class BehaviorPort_state extends Label {
