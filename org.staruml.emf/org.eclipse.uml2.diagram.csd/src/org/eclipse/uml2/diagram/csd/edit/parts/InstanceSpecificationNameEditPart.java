...
public class InstanceSpecificationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InstanceSpecification_2011, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.csd.edit.parts.InstanceSpecificationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			InstanceSpecificationEditPart parent = (InstanceSpecificationEditPart) getParent();
			InstanceSpecificationStereoEditPart stereoLabel = (InstanceSpecificationStereoEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry
					.getType(InstanceSpecificationStereoEditPart.VISUAL_ID));
			if (stereoLabel != null) {
