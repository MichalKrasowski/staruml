 ...
 * @generated
 */
public class CollaborationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CollaborationNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Collaboration_2005, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.csd.edit.parts.CollaborationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			CollaborationEditPart parent = (CollaborationEditPart) getParent();
			CollaborationStereoEditPart stereoLabel = (CollaborationStereoEditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(CollaborationStereoEditPart.VISUAL_ID));
			if (stereoLabel != null) {
