 ...
 * @generated
 */
public class ConnectorName5EditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.csd.edit.parts.ConnectorName5EditPart.VISUAL_ID), new Point(0, -30));
	}

	/**
	 * @generated
	 */
	public ConnectorName5EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Connector_4005, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.csd.edit.parts.ConnectorName5EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	private boolean isVisibleByPreferences() {
		return DiagramIconStylePreferenceHelper.shouldShowLabel(ConnectorName5EditPart.VISUAL_ID, getDiagramPreferencesHint());
	}
