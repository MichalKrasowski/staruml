	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(UMLElementTypes.Property_3007, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.csd.edit.parts.PropertyNameEditPart.VISUAL_ID));
		}
		return parser;
	}
