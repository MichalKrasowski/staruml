...
public class UMLNewDiagramFileWizard extends Wizard {
	 ...
	 * @generated
	 */
	private UMLCompositeStructuresSynchronizationWizardPage synchronizationPage;
	...
	private void createSynchronizationPage(TransactionalEditingDomain editingDomain) {
		synchronizationPage = new UMLCompositeStructuresSynchronizationWizardPage("Select diagram synchronization scheme", editingDomain);
