...
public class ClassModelCreateAction extends Action implements IStarUMLModelAction{
	public static final String ACTION_ID = "CLASS";
	public static final String ACTION_URI = "org.eclipse.uml2.diagram.usecase.createClass_2001";
	public static final String ACTION_TITLE ="Create Class";
	...
	public void run() {
		...
		// ID를 생성한다.
		String objId = "_" + CommonUtil.randomKey() + "-IQtFGb7bHGw";
		// 이름을 생성한다.
