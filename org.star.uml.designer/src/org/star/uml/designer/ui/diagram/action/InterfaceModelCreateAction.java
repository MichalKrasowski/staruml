...
public class InterfaceModelCreateAction extends Action implements IStarUMLModelAction{
	public static final String ACTION_ID = "INTERFACE";
	public static final String ACTION_URI = "org.eclipse.uml2.diagram.class.createInterface_2010";
	public static final String ACTION_TITLE ="Create Interface";
	...
	public InterfaceModelCreateAction() {
		super();
	...
	public void run() {
		...
		// ID를 생성한다.
		String objId = "_" + CommonUtil.randomKey() + "-nebKYR_vWEg";
		// 이름을 생성한다.
